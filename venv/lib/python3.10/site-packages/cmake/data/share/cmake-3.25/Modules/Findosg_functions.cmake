...
function(OSG_FIND_LIBRARY module library)
  ...
  # the variables set by select_library_configurations go out of scope here, so
  # we need to set them again
  set(${module_uc}_LIBRARY
      ${${module_uc}_LIBRARY}
      PARENT_SCOPE)
  set(${module_uc}_LIBRARIES
      ${${module_uc}_LIBRARIES}
      PARENT_SCOPE)
endfunction()

#
# OSG_MARK_AS_ADVANCED Just a convenience function for calling MARK_AS_ADVANCED
#
