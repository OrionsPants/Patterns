...
if(NOT BZIP2_LIBRARIES)
  find_library(
    ...
    NAMES bz2 bzip2 libbz2 libbzip2 NAMES_PER_DIR ${_BZIP2_PATHS}
    PATH_SUFFIXES lib)
  find_library(
    BZIP2_LIBRARY_DEBUG
    NAMES bz2d bzip2d libbz2d libbzip2d NAMES_PER_DIR ${_BZIP2_PATHS}
    PATH_SUFFIXES lib)
...
if(BZIP2_FOUND)
  ...
  if(NOT TARGET BZip2::BZip2)
    ...
    if(BZIP2_LIBRARY_RELEASE)
      ...
      set_target_properties(BZip2::BZip2 PROPERTIES IMPORTED_LOCATION_RELEASE
                                                    "${BZIP2_LIBRARY_RELEASE}")
    endif()
    ...
    if(BZIP2_LIBRARY_DEBUG)
      ...
      set_target_properties(BZip2::BZip2 PROPERTIES IMPORTED_LOCATION_DEBUG
                                                    "${BZIP2_LIBRARY_DEBUG}")
    endif()
    ...
    if(NOT BZIP2_LIBRARY_RELEASE AND NOT BZIP2_LIBRARY_DEBUG)
      set_property(
        TARGET BZip2::BZip2
        APPEND
        PROPERTY IMPORTED_LOCATION "${BZIP2_LIBRARY}")
    endif()
  endif()
endif()
