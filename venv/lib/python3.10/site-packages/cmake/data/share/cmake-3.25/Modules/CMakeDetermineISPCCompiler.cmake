...
if(NOT (("${CMAKE_GENERATOR}" MATCHES "Make") OR ("${CMAKE_GENERATOR}" MATCHES
  ...
  message(
    FATAL_ERROR
      "ISPC language not currently supported by \"${CMAKE_GENERATOR}\" generator"
  )
endif()
...
if(NOT CMAKE_ISPC_COMPILER)
  ...
  if(NOT $ENV{ISPC} STREQUAL "")
    get_filename_component(CMAKE_ISPC_COMPILER_INIT $ENV{ISPC} PROGRAM
                           PROGRAM_ARGS CMAKE_ISPC_FLAGS_ENV_INIT)
    if(CMAKE_ISPC_FLAGS_ENV_INIT)
      set(CMAKE_ISPC_COMPILER_ARG1
          "${CMAKE_ISPC_FLAGS_ENV_INIT}"
          CACHE STRING "First argument to ISPC compiler")
    endif()
    if(NOT EXISTS ${CMAKE_ISPC_COMPILER_INIT})
      message(
        FATAL_ERROR
          "Could not find compiler set in environment variable ISPC:\n$ENV{ISPC}."
      )
    endif()
  endif()
...
if(NOT CMAKE_ISPC_COMPILER_ID_RUN)
  ...
  set(CMAKE_ISPC_COMPILER_ID_TEST_FLAGS_FIRST # setup logic to make sure ISPC
                                              # outputs a file
      "-o cmake_ispc_output")
...
if(NOT _CMAKE_TOOLCHAIN_LOCATION)
  get_filename_component(_CMAKE_TOOLCHAIN_LOCATION "${CMAKE_ISPC_COMPILER}"
                         PATH)
endif()
