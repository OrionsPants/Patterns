...
macro(__aix_compiler_xl lang)
  ...
  if(DEFINED CMAKE_XL_CreateExportList AND CMAKE_XL_CreateExportList STREQUAL
                                           "")
    # Prior to CMake 3.16, CMAKE_XL_CreateExportList held the path to the XL
    # CreateExportList tool. Users could set it to an empty value to skip
    # automatic exports in favor of manual -bE: flags. Preserve that behavior
    # for compatibility (even though it was undocumented).
    set(_OBJECTS "")
  endif()

  # Construct the export list ourselves to pass only the object files so that we
  # export only the symbols actually provided by the sources.
