...
# require the --c89 flag to build a file under the C90 standard. - Earlier
# versions of the compiler had C90 by default, not requiring the
...
if("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "ARM")
  if(CMAKE_C_COMPILER_VERSION VERSION_LESS 5)
    # IAR C Compiler for Arm prior version 5.xx uses XLINK. Support in CMake is
    # not implemented.
    message(
      FATAL_ERROR
        "IAR C Compiler for Arm version ${CMAKE_C_COMPILER_VERSION} not supported by CMake."
    )
  endif()
...
elseif("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "RL78")
  if(CMAKE_C_COMPILER_VERSION VERSION_LESS 2)
    # IAR C Compiler for RL78 prior version 2.xx uses XLINK. Support in CMake is
    # not implemented.
    message(
      FATAL_ERROR
        "IAR C Compiler for RL78 version ${CMAKE_C_COMPILER_VERSION} not supported by CMake."
    )
  endif()
  __compiler_iar_ilink(C)
  __compiler_check_default_language_standard(
