...
if(XMLRPC_C_FOUND)
  ...
  if("${XMLRPC_C_CONFIG_RESULT}" STREQUAL "0")
    ...
    string(REGEX REPLACE " +" ";" XMLRPC_C_CONFIG_CFLAGS
                         "${XMLRPC_C_CONFIG_CFLAGS}")

    # Look for -I options. FIXME: Use these as hints to a find_path call to find
    # the headers.
...
if(XMLRPC_C_FOUND)
  ...
  if("${XMLRPC_C_CONFIG_RESULT}" STREQUAL "0")
    string(REGEX REPLACE " +" ";" XMLRPC_C_CONFIG_LIBS
                         "${XMLRPC_C_CONFIG_LIBS}")
