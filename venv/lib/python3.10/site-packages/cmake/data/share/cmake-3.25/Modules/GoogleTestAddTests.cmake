...
function(escape_square_brackets OUTPUT BRACKET PLACEHOLDER PLACEHOLDER_VAR
         OUTPUT_VAR)
...
function(gtest_discover_tests_impl)
  ...
  if(NOT ${result} EQUAL 0)
    ...
    message(
      FATAL_ERROR "Error running test executable.\n" "  Path: '${path}'\n"
                  "  Result: ${result}\n" "  Output:\n" "    ${output}\n")
  endif()
      ...
      if(NOT line MATCHES "^  ")
        ...
        if(line MATCHES "#")
          ...
          if(NOT _NO_PRETTY_TYPES)
            string(REGEX REPLACE ".*/[0-9]+[ .#]+TypeParam = (.*)" "\\1"
                                 type_parameter "${line}")
          else()
            string(REGEX REPLACE ".*/([0-9]+)[ .#]+TypeParam = .*" "\\1"
                                 type_parameter "${line}")
          endif()
          set(test_name_template
              "@prefix@@pretty_suite@.@pretty_test@<@type_parameter@>@suffix@")
        else()
        ...
        if(test MATCHES "#" AND NOT _NO_PRETTY_VALUES)
          string(REGEX REPLACE "/[0-9]+[ #]+GetParam\\(\\) = " "/" pretty_test
                               "${test}")
        else()
        ...
        if(suite MATCHES "^DISABLED_" OR test MATCHES "^DISABLED_")
          add_command(set_tests_properties "${guarded_testname}" PROPERTIES
                      DISABLED TRUE)
        endif()
