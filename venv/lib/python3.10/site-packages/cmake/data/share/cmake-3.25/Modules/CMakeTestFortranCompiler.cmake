...
cmake_determine_compiler_abi(Fortran
                             ${CMAKE_ROOT}/Modules/CMakeFortranCompilerABI.F90)
if(CMAKE_Fortran_ABI_COMPILED)
  ...
  message(
    STATUS
      "Check for working Fortran compiler: ${CMAKE_Fortran_COMPILER} - skipped")
else()
  cmake_determine_compiler_abi(Fortran
  ...
  if(CMAKE_Fortran_ABI_COMPILED)
    ...
    message(
      STATUS
        "Check for working Fortran 77 compiler: ${CMAKE_Fortran_COMPILER} - skipped"
    )
  endif()
endif()

# This file is used by EnableLanguage in cmGlobalGenerator to determine that the
# selected Fortran compiler can actually compile and link the most basic of
...
if(NOT CMAKE_Fortran_COMPILER_WORKS)
  ...
  try_compile(
    CMAKE_Fortran_COMPILER_WORKS SOURCE_FROM_VAR
    testFortranCompiler.f __TestCompiler_testFortranCompilerSource
...
if(NOT DEFINED CMAKE_Fortran_COMPILER_SUPPORTS_F90)
  message(CHECK_START
          "Checking whether ${CMAKE_Fortran_COMPILER} supports Fortran 90")
  set(__TestCompiler_testFortranCompilerSource
      "
...
")
  try_compile(
    CMAKE_Fortran_COMPILER_SUPPORTS_F90 SOURCE_FROM_VAR
    testFortranCompilerF90.f90 __TestCompiler_testFortranCompilerF90Source
    OUTPUT_VARIABLE OUTPUT)
