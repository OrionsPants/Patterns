...
if(DEFINED __COMPILER_TI_CXX14_VERSION
   AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL
       "${__COMPILER_TI_CXX14_VERSION}")
...
elseif(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL
       "${__COMPILER_TI_CXX03_VERSION}")
...
# Architecture specific CXX98 versions:
...
if("${CMAKE_CXX_COMPILER_ARCHITECTURE_ID}" STREQUAL "ARM")
  __compiler_check_default_language_standard(CXX 4.5 98
                                             ${__COMPILER_TI_CXX14_VERSION} 14)
