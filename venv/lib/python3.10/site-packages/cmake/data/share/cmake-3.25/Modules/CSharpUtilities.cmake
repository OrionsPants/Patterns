...
function(csharp_set_windows_forms_properties)
  ...
  foreach(key ${fileKeys})
    ...
    if(${ext} STREQUAL ".DESIGNER.CS" OR ${ext} STREQUAL ".RESX")
      ...
      if(NOT ${FILE_INDEX} EQUAL -1)
        ...
        set_source_files_properties("${FILE_NAME}" PROPERTIES VS_CSHARP_SubType
                                                              "Form")
        ...
        if(NOT ${FILE_INDEX} EQUAL -1)
          ...
          set_source_files_properties(
            "${FILE_NAME}"
            PROPERTIES VS_CSHARP_DependentUpon "${LINK}"
        ...
        if(NOT ${FILE_INDEX} EQUAL -1)
          ...
          set_source_files_properties(
            "${FILE_NAME}"
            PROPERTIES VS_RESOURCE_GENERATOR ""
  ...
  foreach(key ${fileKeys})
    ...
    if(${ext} STREQUAL ".DESIGNER.CS")
      ...
      if("${NAME_BASE}.RESX" IN_LIST fileKeys)
        ...
        set_source_files_properties(
          "${source}"
          PROPERTIES VS_CSHARP_AutoGen "True"
                     VS_CSHARP_DesignTime "True"
                     VS_CSHARP_DependentUpon "${LINK}")
      elseif("${NAME_BASE}.CS" IN_LIST fileKeys)
        ...
        csharp_get_dependentupon_name(LINK "${FILE_NAME}")
        set_source_files_properties(
          "${source}" PROPERTIES VS_CSHARP_DependentUpon "${LINK}")
