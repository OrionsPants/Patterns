...
if(NOT CURL_NO_CURL_CMAKE)
  # do a find package call to specifically look for the CMake version of curl
  find_package(CURL QUIET NO_MODULE)
  mark_as_advanced(CURL_DIR)

  # if we found the CURL cmake package then we are done, and can print what we
  # found and return.
  if(CURL_FOUND)
...
if(NOT CURL_LIBRARY)
  ...
  find_library(
    CURL_LIBRARY_DEBUG
    NAMES # Windows MSVC CMake builds in debug configuration on vcpkg:
          libcurl-d_imp libcurl-d NAMES_PER_DIR
    HINTS ${PC_CURL_LIBRARY_DIRS})
