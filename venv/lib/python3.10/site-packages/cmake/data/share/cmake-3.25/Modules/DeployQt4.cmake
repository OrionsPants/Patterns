...
# The functions defined in this file depend on the fixup_bundle function (and
# others) found in BundleUtilities.cmake
...
function(install_qt4_plugin plugin executable copy installed_plugin_path_var)
  ...
  if(EXISTS "${plugin}")
    ...
    if(DEFINED "${plugin_release_var}"
       AND DEFINED "${plugin_debug_var}"
       AND NOT EXISTS "${plugin_release}"
       AND NOT EXISTS "${plugin_debug}")
    ...
    if(_isMultiConfig OR CMAKE_BUILD_TYPE)
      ...
      install_qt4_plugin_path(
        "${plugin_release}" "${executable}" "${copy}"
...
function(install_qt4_executable executable)
  ...
  install(
    CODE "include(\"${CMAKE_CURRENT_FUNCTION_LIST_DIR}/DeployQt4.cmake\")
