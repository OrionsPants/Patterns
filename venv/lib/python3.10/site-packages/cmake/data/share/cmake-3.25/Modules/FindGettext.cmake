...
if(GETTEXT_MSGMERGE_EXECUTABLE)
  execute_process(
    COMMAND ${GETTEXT_MSGMERGE_EXECUTABLE} --version
  ...
  if(gettext_version MATCHES
     "^(${msgmerge_name}|${msgmerge_namewe}) \\([^\\)]*\\) ([0-9\\.]+[^ \n]*)")
...
function(GETTEXT_PROCESS_POT_FILE _potFile)
  ...
  cmake_parse_arguments(_parsedArguments "${_options}" "${_oneValueArgs}"
  ...
  foreach(_lang ${_parsedArguments_LANGUAGES})
    ...
    if(_parsedArguments_INSTALL_DESTINATION)
      install(
        FILES ${_gmoFile}
        DESTINATION ${_parsedArguments_INSTALL_DESTINATION}/${_lang}/LC_MESSAGES
        RENAME ${_potBasename}.mo)
    endif()
