  ...
  \"${extra_compiler_variables}\\n\"
    ...
    execute_process(
      ...
      COMMAND
        ...
        "${CMAKE_GENERATOR_PLATFORM}" -T "${CMAKE_GENERATOR_TOOLSET}"
        ${_D_CMAKE_GENERATOR_INSTANCE} ${_D_CMAKE_MAKE_PROGRAM}
    ...
    if(CMAKE_${lang}_HOST_COMPILER)
      message(
        STATUS
          "Looking for a ${lang} host compiler - ${CMAKE_${lang}_HOST_COMPILER}"
      )
