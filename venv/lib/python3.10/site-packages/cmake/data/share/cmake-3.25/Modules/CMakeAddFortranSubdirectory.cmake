...
function(_add_fortran_library_link_interface library depend_library)
  set_target_properties(
    ${library} PROPERTIES IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG
                          "${depend_library}")
endfunction()
...
function(cmake_add_fortran_subdirectory subdir)
  ...
  # if we have MSVC without Intel fortran then setup external projects to build
  # with mingw fortran
  ...
  foreach(dir_var library_dir binary_dir)
    if(NOT IS_ABSOLUTE "${${dir_var}}")
      get_filename_component(
        ${dir_var} "${CMAKE_CURRENT_BINARY_DIR}/${${dir_var}}" ABSOLUTE)
    endif()
  endforeach()
  ...
  foreach(lib ${libraries})
    ...
    set_target_properties(
      ${lib}
      PROPERTIES IMPORTED_IMPLIB_NOCONFIG "${library_dir}/lib${lib}.lib"
