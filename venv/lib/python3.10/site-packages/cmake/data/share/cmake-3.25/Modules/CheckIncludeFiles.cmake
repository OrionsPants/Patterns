  ...
  if(NOT DEFINED "${VARIABLE}")
    ...
    if("x${ARGN}" STREQUAL "x")
      ...
      elseif(CMAKE_CXX_COMPILER_LOADED)
        ...
        message(
          FATAL_ERROR
            "CHECK_INCLUDE_FILES needs either C or CXX language enabled.\n")
      endif()
    ...
    foreach(FILE ${INCLUDE})
      string(APPEND _src_content "#include <${FILE}>\n")
    endforeach()
    ...
    if("${_INCLUDE}" MATCHES "^([^;]+);.+;([^;]+)$")
      ...
      set(_description
          "${_INCLUDE_LEN} include files ${CMAKE_MATCH_1}, ..., ${CMAKE_MATCH_2}"
      )
    ...
    if(CMAKE_REQUIRED_LIBRARIES)
      cmake_policy(
        GET CMP0075 _CIF_CMP0075 PARENT_SCOPE # undocumented, do not use outside
                                              # of CMake
      )
    ...
    try_compile(
      ...
      "${src}" _src_content
      COMPILE_DEFINITIONS ${CMAKE_REQUIRED_DEFINITIONS} ${_CIF_LINK_OPTIONS}
                          ${_CIF_LINK_LIBRARIES}
      CMAKE_FLAGS
    ...
    if(${VARIABLE})
      ...
      set(${VARIABLE}
          1
          CACHE INTERNAL "Have include ${INCLUDE}")
      ...
      set(${VARIABLE}
          ""
          CACHE INTERNAL "Have includes ${INCLUDE}")
      file(
