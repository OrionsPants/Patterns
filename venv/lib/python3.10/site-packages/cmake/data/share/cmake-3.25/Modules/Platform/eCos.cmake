...
set(CMAKE_EXECUTABLE_SUFFIX ".elf") # same suffix as if built using
                                    # UseEcos.cmake
set(CMAKE_DL_LIBS "")
...
if(NOT ECOS_SYSTEM_CONFIG_HEADER_PATH)
  message(
    FATAL_ERROR
      "Could not find eCos pkgconf/system.h. Build eCos first and set up CMAKE_FIND_ROOT_PATH correctly."
  )
endif()
...
if(NOT ECOS_SYSTEM_TARGET_LIBRARY)
  message(
    FATAL_ERROR
      "Could not find eCos \"libtarget.a\". Build eCos first and set up CMAKE_FIND_ROOT_PATH correctly."
  )
endif()

get_filename_component(ECOS_LIBTARGET_DIRECTORY "${ECOS_SYSTEM_TARGET_LIBRARY}"
                       PATH)
...
set(CMAKE_CXX_LINK_EXECUTABLE
    "<CMAKE_CXX_COMPILER> <FLAGS> <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> -o <TARGET> -nostdlib -nostartfiles -L${ECOS_LIBTARGET_DIRECTORY} -Ttarget.ld <LINK_LIBRARIES>"
)
set(CMAKE_C_LINK_EXECUTABLE
    "<CMAKE_C_COMPILER> <FLAGS> <CMAKE_C_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> -o <TARGET> -nostdlib -nostartfiles -L${ECOS_LIBTARGET_DIRECTORY} -Ttarget.ld <LINK_LIBRARIES>"
)
