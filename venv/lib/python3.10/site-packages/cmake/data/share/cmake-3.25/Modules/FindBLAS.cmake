...
function(_add_blas_target)
  if(BLAS_FOUND AND NOT TARGET BLAS::BLAS)
    ...
    if(BLAS_LINKER_FLAGS)
      set_target_properties(BLAS::BLAS PROPERTIES INTERFACE_LINK_OPTIONS
                                                  "${BLAS_LINKER_FLAGS}")
    endif()
  endif()
endfunction()
  ...
  if(NOT BLAS_LIBRARIES)
    if(CMAKE_C_COMPILER_LOADED OR CMAKE_CXX_COMPILER_LOADED)
      ...
      if(WIN32)
        ...
        if(CMAKE_Fortran_COMPILER_LOADED
           AND (CMAKE_Fortran_COMPILER_ID STREQUAL "GNU"
                OR CMAKE_Fortran_COMPILER_ID STREQUAL "LCC")
           AND NOT APPLE)
      ...
      if(BLA_VENDOR MATCHES "^Intel10_64_dyn$" OR BLA_VENDOR STREQUAL "All")
        ...
        list(APPEND BLAS_SEARCH_LIBS "mkl_rt")
      endif()
      ...
      if(DEFINED ENV{MKLROOT})
        ...
        # or 'tbb':
        get_filename_component(BLAS_mkl_MKLROOT_LAST_DIR "${BLAS_mkl_MKLROOT}"
                               NAME)
...
if(BLA_VENDOR STREQUAL "OpenBLAS" OR BLA_VENDOR STREQUAL "All")
  ...
  if(NOT BLAS_LIBRARIES AND (CMAKE_C_COMPILER_LOADED
                             OR CMAKE_CXX_COMPILER_LOADED))
    if(BLAS_FIND_QUIETLY OR NOT BLAS_FIND_REQUIRED)
      find_package(Threads)
    else()
...
# On compilers that implicitly link BLAS (i.e. CrayPrgEnv) we used a placeholder
# for empty BLAS_LIBRARIES to get through our logic above.
