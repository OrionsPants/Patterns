...
function(__gtest_import_library _target _var _config)
  ...
  if(EXISTS "${_lib}")
    ...
    set_target_properties(
      ${_target} PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES${_config_suffix}
                            "CXX")
    if(WIN32 AND ${_var}_TYPE STREQUAL SHARED)
      set_target_properties(
        ${_target} PROPERTIES IMPORTED_IMPLIB${_config_suffix} "${_lib}")
    else()
      set_target_properties(
...
function(__gtest_define_backwards_compatible_library_targets)
  ...
  # Add targets mapping the same library names as defined in older versions of
  # CMake's FindGTest
...
# if we found the GTest cmake package then we are done, and can print what we
# found and return.
if(GTest_FOUND)
...
if(GTest_FOUND)
  ...
  if(NOT TARGET GTest::gtest)
    ...
    if(GTEST_LIBRARY_TYPE STREQUAL "SHARED")
      set_target_properties(
        GTest::gtest PROPERTIES INTERFACE_COMPILE_DEFINITIONS
                                "GTEST_LINKED_AS_SHARED_LIBRARY=1")
    endif()
    if(GTEST_INCLUDE_DIRS)
      set_target_properties(
        GTest::gtest PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                "${GTEST_INCLUDE_DIRS}")
    endif()
...
if(GMock_FOUND AND GTest_FOUND)
  if(NOT TARGET GTest::gmock)
    ...
    if(GMOCK_LIBRARY_TYPE STREQUAL "SHARED")
      set_target_properties(
        GTest::gmock PROPERTIES INTERFACE_COMPILE_DEFINITIONS
                                "GMOCK_LINKED_AS_SHARED_LIBRARY=1")
    endif()
    if(GTEST_INCLUDE_DIRS)
      set_target_properties(
        GTest::gmock PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                "${GTEST_INCLUDE_DIRS}")
    endif()
