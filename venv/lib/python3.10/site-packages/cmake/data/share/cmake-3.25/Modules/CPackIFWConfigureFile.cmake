...
# NOTE: This file used to himself packaging via CPack IFW generator and should
# be compatible with minimal CMake version defined in ../CMakeLists.txt file.
    ...
    foreach(_tmp_regex "%{([^%}]+)}" "%([^%]+)%")
      ...
      while(_tmp_vars)
        foreach(_tmp_var ${_tmp_vars})
          string(REGEX REPLACE "${_tmp_regex}" "\\1" _tmp_var_name
                               "${_tmp_var}")
