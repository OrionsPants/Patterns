...
if(FLEX_EXECUTABLE)
  ...
  if(NOT ${FLEX_version_result} EQUAL 0)
    ...
    string(
      REGEX
      REPLACE
        "^.*${FLEX_EXE_NAME_WE}(${FLEX_EXE_EXT})?\"? (version )?([0-9]+[^ ]*)( .*)?$"
        "\\3"
        FLEX_VERSION
        "${FLEX_version_output}")
    unset(FLEX_EXE_EXT)
  ...
  macro(FLEX_TARGET Name Input Output)
    ...
    cmake_parse_arguments(
      FLEX_TARGET_ARG "${FLEX_TARGET_PARAM_OPTIONS}"
      "${FLEX_TARGET_PARAM_ONE_VALUE_KEYWORDS}"
      "${FLEX_TARGET_MULTI_VALUE_KEYWORDS}" ${ARGN})
    ...
    if(NOT "${FLEX_TARGET_ARG_UNPARSED_ARGUMENTS}" STREQUAL "")
      ...
      cmake_policy(
        GET CMP0098 _flex_CMP0098 PARENT_SCOPE # undocumented, do not use
                                               # outside of CMake
      )
      ...
      add_custom_command(
        OUTPUT ${_flex_TARGET_OUTPUTS}
        COMMAND ${FLEX_EXECUTABLE} ${_flex_EXE_OPTS} -o${_flex_OUTPUT}
                ${_flex_INPUT}
        VERBATIM
        DEPENDS ${_flex_INPUT}
        COMMENT
          "[FLEX][${Name}] Building scanner with ${_flex_EXE_NAME_WE} ${FLEX_VERSION}"
