...
# determine the compiler to use for RC programs NOTE, a generator may set
# CMAKE_RC_COMPILER before loading this file to force a compiler. use
# environment variable RC first if defined by user, next use the cmake variable
# CMAKE_GENERATOR_RC which can be defined by a generator as a default compiler
if(NOT CMAKE_RC_COMPILER)
  # prefer the environment variable RC
  if(NOT $ENV{RC} STREQUAL "")
    get_filename_component(CMAKE_RC_COMPILER_INIT $ENV{RC} PROGRAM PROGRAM_ARGS
                           CMAKE_RC_FLAGS_ENV_INIT)
    if(CMAKE_RC_FLAGS_ENV_INIT)
      set(CMAKE_RC_COMPILER_ARG1
          "${CMAKE_RC_FLAGS_ENV_INIT}"
          CACHE STRING "Arguments to RC compiler")
    endif()
