...
if(PERL_EXECUTABLE)
  ...
  if(CMAKE_SYSTEM_NAME MATCHES "MSYS|CYGWIN")
    ...
    # library name rather than the import library. So, extends possible library
    # names
  ...
  find_library(
    PERL_LIBRARY
    NAMES ${PERL_POSSIBLE_LIBRARY_NAMES}
    PATHS "${PERL_UPDATE_ARCHLIB}/CORE"
          "${PERL_ARCHLIB}/CORE"
          /usr/lib/perl5/${PERL_VERSION_STRING}/${PERL_ARCHNAME}/CORE
          /usr/lib/perl/${PERL_VERSION_STRING}/${PERL_ARCHNAME}/CORE
...
find_package_handle_standard_args(
  PerlLibs
  REQUIRED_VARS PERL_LIBRARY PERL_INCLUDE_PATH
...
mark_as_advanced(PERL_INCLUDE_PATH PERL_LIBRARY)
