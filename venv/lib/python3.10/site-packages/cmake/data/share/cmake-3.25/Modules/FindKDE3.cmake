...
if(NOT UNIX AND KDE3_FIND_REQUIRED)
  message(
    FATAL_ERROR
      "Compiling KDE3 applications and libraries under Windows is not supported"
  )
endif()
...
if(QT4_FOUND)
  if(KDE3_FIND_REQUIRED)
    message(
      FATAL_ERROR "KDE3/Qt3 and Qt4 cannot be used together in one project.")
  else()
...
find_program(
  ...
  PATHS /opt/kde3/bin /opt/kde/bin)
...
# at first the KDE include directory kpassdlg.h comes from kdeui and doesn't
# exist in KDE4 anymore
find_path(
  KDE3_INCLUDE_DIR kpassdlg.h
  HINTS $ENV{KDEDIR}/include ${KDE3PREFIX}/include
  PATHS /opt/kde3/include /opt/kde/include
...
find_library(
  ...
  NAMES kdecore
  HINTS $ENV{KDEDIR}/lib ${KDE3PREFIX}/lib
  PATHS /opt/kde3/lib /opt/kde/lib)
...
find_program(
  KDE3_DCOPIDL_EXECUTABLE
  NAMES dcopidl
  HINTS $ENV{KDEDIR}/bin ${KDE3PREFIX}/bin
  PATHS /opt/kde3/bin /opt/kde/bin)
...
if(KDE3_INCLUDE_DIR
   AND KDE3_LIB_DIR
   AND KDE3_DCOPIDL_EXECUTABLE
   AND KDE3_DCOPIDL2CPP_EXECUTABLE
   AND KDE3_KCFGC_EXECUTABLE)
  set(KDE3_FOUND TRUE)
else()
...
if(KDE3_FOUND)
  ...
  if(CMAKE_COMPILER_IS_GNUCXX)
    ...
    # gnu gcc 2.96 does not work with flags I guess 2.95 also doesn't then
  ...
  if(CMAKE_SYSTEM_NAME MATCHES "Linux" AND _KDE3_USE_FLAGS)
    ...
    set(CMAKE_C_FLAGS
        "${CMAKE_C_FLAGS} -Wno-long-long -ansi -Wundef -Wcast-align -Wconversion -Wchar-subscripts -Wall -W -Wpointer-arith -Wwrite-strings -Wformat-security -Wmissing-format-attribute -fno-common"
    )
    set(CMAKE_CXX_FLAGS
        "${CMAKE_CXX_FLAGS} -Wnon-virtual-dtor -Wno-long-long -ansi -Wundef -Wcast-align -Wconversion -Wchar-subscripts -Wall -W -Wpointer-arith -Wwrite-strings -Wformat-security -fno-exceptions -fno-check-new -fno-common"
    )
  endif()
  ...
  if(CMAKE_SYSTEM_NAME MATCHES BSD AND _KDE3_USE_FLAGS)
    ...
    set(CMAKE_CXX_FLAGS
        "${CMAKE_CXX_FLAGS} -Wnon-virtual-dtor -Wno-long-long -Wundef -Wcast-align -Wconversion -Wchar-subscripts -Wall -W -Wpointer-arith -Wwrite-strings -Wformat-security -Wmissing-format-attribute -fno-exceptions -fno-check-new -fno-common"
    )
  endif()
  ...
  # -Wl,--allow-shlib-undefined") set(CMAKE_SHARED_LINKER_FLAGS
  # "-Wl,--fatal-warnings -avoid-version -Wl,--no-undefined -lc")
...
macro(KDE3_PRINT_RESULTS)
  ...
  if(KDE3_DCOPIDL_EXECUTABLE)
    message(
      STATUS "Found KDE3 dcopidl preprocessor: ${KDE3_DCOPIDL_EXECUTABLE}")
  else()
  ...
  if(KDE3_DCOPIDL2CPP_EXECUTABLE)
    message(
      STATUS
        "Found KDE3 dcopidl2cpp preprocessor: ${KDE3_DCOPIDL2CPP_EXECUTABLE}")
  else()
  ...
  if(KDE3_KCFGC_EXECUTABLE)
    message(
      STATUS
        "Found KDE3 kconfig_compiler preprocessor: ${KDE3_KCFGC_EXECUTABLE}")
  else()
