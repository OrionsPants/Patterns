...
# CMAKE_CXX_COMPILER before loading this file to force a compiler. use
# environment variable CXX first if defined by user, next use the cmake variable
# CMAKE_GENERATOR_CXX which can be defined by a generator as a default compiler
# If the internal cmake variable _CMAKE_TOOLCHAIN_PREFIX is set, this is used as
# prefix for the tools (e.g. arm-elf-g++, arm-elf-ar etc.)
#
# Sets the following variables: CMAKE_CXX_COMPILER CMAKE_COMPILER_IS_GNUCXX
...
elseif("${CMAKE_GENERATOR}" MATCHES "Xcode")
  ...
  if(NOT CMAKE_CXX_COMPILER)
    ...
    if(NOT $ENV{CXX} STREQUAL "")
      get_filename_component(CMAKE_CXX_COMPILER_INIT $ENV{CXX} PROGRAM
                             PROGRAM_ARGS CMAKE_CXX_FLAGS_ENV_INIT)
      if(CMAKE_CXX_FLAGS_ENV_INIT)
        set(CMAKE_CXX_COMPILER_ARG1
            "${CMAKE_CXX_FLAGS_ENV_INIT}"
...
if(CMAKE_CXX_COMPILER_TARGET)
  set(CMAKE_CXX_COMPILER_ID_TEST_FLAGS_FIRST
      "-c --target=${CMAKE_CXX_COMPILER_TARGET}")
endif()
...
if(NOT CMAKE_CXX_COMPILER_ID_RUN)
  ...
  # /path/to/cc ...CompilerIdCXX/... to extract the compiler front-end for the
  # language.
  ...
  if(NOT DEFINED CMAKE_CXX_COMPILER_FRONTEND_VARIANT)
    # Some toolchain files set our internal CMAKE_CXX_COMPILER_ID_RUN variable
    # but are not aware of CMAKE_CXX_COMPILER_FRONTEND_VARIANT. They pre-date
    # our support for the GNU-like variant targeting the MSVC ABI so we do not
    # consider that here.
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang" OR "x${CMAKE_CXX_COMPILER_ID}"
                                                 STREQUAL "xIntelLLVM")
...
if(CMAKE_CXX_COMPILER_SYSROOT)
  string(
    CONCAT _SET_CMAKE_CXX_COMPILER_SYSROOT
...
configure_file(${CMAKE_ROOT}/Modules/CMakeCXXCompiler.cmake.in
               ${CMAKE_PLATFORM_INFO_DIR}/CMakeCXXCompiler.cmake @ONLY)
