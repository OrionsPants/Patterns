...
# should. For example, deletion of moves is specified to also suppress copies,
...
# http://blogs.msdn.com/b/vcblog/archive/2014/11/17/c-11-14-17-features-in-vs-2015-preview.aspx
# Note 1. While previous version of VisualStudio said they supported these they
# silently produced bad code, and are now marked as having partial support in
# previous versions. The footnote says the support will be complete in MSVC
# 2015, so support the feature for that version, assuming that is true. The blog
# post also says that VS 2013 Update 3 generates an error in cases that
# previously produced bad code.
set(_cmake_feature_test_cxx_generalized_initializers
...
# Unset all the variables that we don't need exposed. _cmake_oldestSupported is
# required by WriteCompilerDetectionHeader
set(MSVC_2017)
set(MSVC_2015)
set(MSVC_2013)
set(MSVC_2012)
