# No known reference for AppleClang versions. Generic reference:
# http://clang.llvm.org/cxx_status.html
# http://clang.llvm.org/docs/LanguageExtensions.html

# Note: CXX compiler in Xcode 4.3 does not set __apple_build_version__ and so is
# not recognized as AppleClang. Xcode_43 - Apple clang version 3.1
# (tags/Apple/clang-318.0.61) (based on LLVM 3.1svn) Xcode_44 - Apple clang
# version 4.0 (tags/Apple/clang-421.0.60) (based on LLVM 3.1svn) Xcode_45 -
...
# There is some non-correspondance. __has_feature(cxx_user_literals) is false
# for AppleClang 4.0 and 4.1, although it is reported as supported in the
# reference link for Clang 3.1.  The compiler does not pass the
# CompileFeatures/cxx_user_literals.cpp test. cxx_attributes is listed as not
# supported until Clang 3.3. It works without warning with AppleClang 5.0, but
# issues a gcc-compat warning for AppleClang 4.0-4.2. cxx_alignof and
# cxx_alignas tests work for early AppleClang versions, though they are listed
# as supported for Clang 3.3 and later.
...
set(AppleClang51_CXX14
    "((__clang_major__ * 100) + __clang_minor__) >= 501 && __cplusplus > 201103L"
)
