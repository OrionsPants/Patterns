...
if("${CMAKE_GENERATOR}" MATCHES "MinGW" AND "${FortranCInterface_SOURCE_DIR}"
                                            MATCHES "[()]")
    ...
    if("${f}" MATCHES ":")
      ...
      if(FortranCInterface_MODULE${form}_MACRO)
        string(
          APPEND
          HEADER_CONTENT
          "#define ${SYMBOL_NAMESPACE}${module}_${function} ${MACRO_NAMESPACE}MODULE${form}(${m_lower},${f_lower}, ${m_upper},${f_upper})\n"
        )
      else()
      ...
      if(FortranCInterface_GLOBAL${form}_MACRO)
        string(
          APPEND
          HEADER_CONTENT
          "#define ${SYMBOL_NAMESPACE}${f} ${MACRO_NAMESPACE}GLOBAL${form}(${f_lower}, ${f_upper})\n"
        )
      else()
        message(AUTHOR_WARNING "No FortranCInterface mangling known for ${f}")
      endif()
...
function(FortranCInterface_VERIFY)
  ...
  if(NOT DEFINED FortranCInterface_VERIFIED_${lang})
    ...
    # Perform verification with only one architecture. FIXME: Add try_compile
    # whole-project option to forward architectures.
    if(CMAKE_OSX_ARCHITECTURES MATCHES "^([^;]+)(;|$)")
      set(_FortranCInterface_OSX_ARCH
          "-DCMAKE_OSX_ARCHITECTURES=${CMAKE_MATCH_1}")
    else()
      set(_FortranCInterface_OSX_ARCH "")
    endif()
    ...
    try_compile(
      FortranCInterface_VERIFY_${lang}_COMPILED PROJECT
      VerifyFortranC
      TARGET
      VerifyFortranC
      SOURCE_DIR
    ...
    file(WRITE "${FortranCInterface_BINARY_DIR}/Verify${lang}/output.txt"
         "${_output}")
    ...
    if(FortranCInterface_VERIFY_${lang}_COMPILED)
      ...
      set(FortranCInterface_VERIFIED_${lang}
          1
          CACHE INTERNAL "Fortran/${lang} compatibility")
    else()
  ...
  if(NOT FortranCInterface_VERIFIED_${lang} AND NOT quiet)
    file(READ "${FortranCInterface_BINARY_DIR}/Verify${lang}/output.txt"
         _output)
    string(REPLACE "\n" "\n  " _output "${_output}")
    message(
      FATAL_ERROR
