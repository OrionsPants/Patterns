...
# This file sets the basic flags for the Fortran language in CMake. It also
# loads the available platform file for the system-compiler if it exists.
...
if(CMAKE_Fortran_COMPILER_ID)
  include(
    Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_Fortran_COMPILER_ID}-Fortran
...
# Create a set of shared library variable specific to Fortran For 90% of the
...
if(NOT DEFINED CMAKE_SHARED_LIBRARY_RUNTIME_Fortran_FLAG)
  set(CMAKE_SHARED_LIBRARY_RUNTIME_Fortran_FLAG
...
if(NOT DEFINED CMAKE_SHARED_LIBRARY_RPATH_LINK_Fortran_FLAG)
  set(CMAKE_SHARED_LIBRARY_RPATH_LINK_Fortran_FLAG
...
if(NOT CMAKE_MODULE_EXISTS)
  ...
  set(CMAKE_SHARED_MODULE_CREATE_Fortran_FLAGS
...
cmake_initialize_per_config_variable(CMAKE_Fortran_FLAGS
                                     "Flags used by the Fortran compiler")

if(NOT CMAKE_Fortran_COMPILER_LAUNCHER AND DEFINED
                                           ENV{CMAKE_Fortran_COMPILER_LAUNCHER})
...
# now define the following rule variables CMAKE_Fortran_CREATE_SHARED_LIBRARY
...
# CMAKE_Fortran_CREATE_STATIC_LIBRARY is set it will override these.
...
# compile a Fortran file into an object file (put -o after -c to workaround bug
# in at least one mpif77 wrapper)
...
if(CMAKE_Fortran_STANDARD_LIBRARIES_INIT)
  set(CMAKE_Fortran_STANDARD_LIBRARIES
      "${CMAKE_Fortran_STANDARD_LIBRARIES_INIT}"
