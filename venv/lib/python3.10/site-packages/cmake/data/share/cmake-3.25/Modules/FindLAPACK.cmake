...
function(_add_lapack_target)
  if(LAPACK_FOUND AND NOT TARGET LAPACK::LAPACK)
    ...
    if(_lapack_flags)
      set_target_properties(LAPACK::LAPACK PROPERTIES INTERFACE_LINK_OPTIONS
                                                      "${_lapack_flags}")
    endif()
  endif()
endfunction()
...
function(
  ...
  _subdirs
  _blas)
  # This function checks for the existence of the combination of libraries given
  # by _list.  If the combination is found, this checks whether can link against
  # that library combination using the name of a routine given by _name using
  # the linker flags given by _flags.  If the combination of libraries is found
  # and passes the link test, ${LIBRARIES} is set to the list of complete
  # library paths that have been found.  Otherwise, ${LIBRARIES} is set to
  # FALSE.
...
elseif(
  (BLA_SIZEOF_INTEGER STREQUAL "ANY")
  OR (BLA_SIZEOF_INTEGER STREQUAL "4")
  OR (BLA_SIZEOF_INTEGER STREQUAL "8"))
  set(_lapack_sizeof_integer ${BLA_SIZEOF_INTEGER})
else()
  message(
    FATAL_ERROR
      "BLA_SIZEOF_INTEGER can have only <no value>, ANY, 4, or 8 values")
endif()
...
if(NOT LAPACK_NOT_FOUND_MESSAGE)
  ...
  if(NOT LAPACK_LIBRARIES AND (BLA_VENDOR MATCHES "SCSL" OR BLA_VENDOR STREQUAL
                                                            "All"))
  ...
  # Elbrus Math Library?
  if(NOT LAPACK_LIBRARIES AND (BLA_VENDOR MATCHES "EML" OR BLA_VENDOR STREQUAL
                                                           "All"))
  ...
  if(NOT LAPACK_LIBRARIES AND (BLA_VENDOR MATCHES "Fujitsu_SSL2"
  ...
  if(NOT LAPACK_LIBRARIES AND (BLA_VENDOR MATCHES "IBMESSL" OR BLA_VENDOR
                                                               STREQUAL "All"))
  ...
  if(NOT LAPACK_LIBRARIES AND (BLA_VENDOR MATCHES "NVHPC" OR BLA_VENDOR STREQUAL
                                                             "All"))
    ...
    if(";${CMAKE_C_COMPILER_ID};${CMAKE_CXX_COMPILER_ID};${CMAKE_Fortran_COMPILER_ID};"
       MATCHES
       ";(NVHPC|PGI);")
    ...
    # an additional check for NVHPC 2020 which does not have differentiation
  ...
  if(NOT LAPACK_LIBRARIES
    ...
    if(BLA_STATIC)
      # We do not know for sure how the LAPACK reference implementation is built
      # on this host.  Guess typical dependencies.
...
find_package_handle_standard_args(
  LAPACK REQUIRED_VARS ${_lapack_fphsa_req_var} ${LAPACK_NOT_FOUND_MESSAGE})
