...
if("x${CMAKE_C_SIMULATE_ID}" STREQUAL "xMSVC"
  ...
  macro(__compiler_clang lang)
    ...
    # Link options for PIE are already set in 'Compiler/GNU.cmake' but clang may
    # require alternate syntax on some platforms
    if(APPLE)
      set(CMAKE_${lang}_LINK_OPTIONS_PIE ${CMAKE_${lang}_COMPILE_OPTIONS_PIE}
                                         -Xlinker -pie)
    ...
    if(CMAKE_${lang}_COMPILER_TARGET)
      if(CMAKE_${lang}_COMPILER_VERSION VERSION_LESS 3.4.0)
        list(APPEND CMAKE_${lang}_COMPILER_PREDEFINES_COMMAND "-target"
             "${CMAKE_${lang}_COMPILER_TARGET}")
      else()
        list(APPEND CMAKE_${lang}_COMPILER_PREDEFINES_COMMAND
             "--target=${CMAKE_${lang}_COMPILER_TARGET}")
      endif()
    endif()
    ...
    string(COMPARE EQUAL "${CMAKE_${lang}_COMPILER_ID}" "AppleClang"
                   __is_apple_clang)
    string(COMPARE EQUAL "${CMAKE_${lang}_COMPILER_ID}" "FujitsuClang"
                   __is_fujitsu_clang)
    ...
    set(CMAKE_${lang}_ARCHIVE_FINISH_IPO "\"${__ranlib}\" <TARGET>")

    set(CMAKE_PCH_EXTENSION .pch)
    if(NOT CMAKE_GENERATOR MATCHES "Xcode")
      set(CMAKE_PCH_PROLOGUE "#pragma clang system_header")
    endif()
    if(CMAKE_${lang}_COMPILER_VERSION VERSION_GREATER_EQUAL 11.0.0
       AND NOT __is_apple_clang)
      set(CMAKE_${lang}_COMPILE_OPTIONS_INSTANTIATE_TEMPLATES_PCH
    ...
    if(CMAKE_${lang}_COMPILER_VERSION VERSION_GREATER_EQUAL 2.6)
      ...
      set(CMAKE_${lang}_COMPILE_OPTIONS_COLOR_DIAGNOSTICS_OFF
...
macro(__compiler_clang_cxx_standards lang)
  if("x${CMAKE_${lang}_COMPILER_FRONTEND_VARIANT}" STREQUAL "xGNU")
    ...
    if(NOT CMAKE_${lang}_COMPILER_VERSION VERSION_LESS
       "${_clang_version_std17}")
    ...
    elseif(NOT CMAKE_${lang}_COMPILER_VERSION VERSION_LESS
           "${_clang_version_std17}")
    ...
    if("x${CMAKE_${lang}_SIMULATE_ID}" STREQUAL "xMSVC")
      # The MSVC standard library requires C++14, and MSVC itself has no notion
      # of operating in a mode not aware of at least that standard.
  ...
  elseif(CMAKE_${lang}_COMPILER_VERSION VERSION_GREATER_EQUAL 3.9
    ...
    # This version of clang-cl and the MSVC version it simulates have support
    # for -std: flags.
    ...
    # Override the default macro for this special case.  Pretend that all
    # language standards are available so that at least compilation can be
    # attempted.
