...
if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 21.07)
  ...
  # Before NVHPC 21.07 the `-MD` flag implicitly implies `-E` and therefore
  # compilation and dependency generation can't occur in the same invocation
  set(CMAKE_CXX_DEPENDS_EXTRA_COMMANDS
      "<CMAKE_CXX_COMPILER> <DEFINES> <INCLUDES> <FLAGS> -x c++ -M <SOURCE> -MT <OBJECT> -MD<DEP_FILE>"
  )
endif()
