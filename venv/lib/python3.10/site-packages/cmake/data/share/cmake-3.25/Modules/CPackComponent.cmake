...
if(NOT CPackComponent_CMake_INCLUDED)
  ...
  # Function that appends a SET command for the given variable name (var) to the
  # string named strvar, but only if the variable named "var" has been defined.
  ...
  # Function that appends a SET command for the given variable name (var) to the
  # string named strvar, but only if the variable named "var" has been defined
  # and is a string. The string will eventually be appended to a CPack
  # configuration file.
  ...
  # Macro that appends a SET command for the given list variable name (var) to
  # the macro named strvar, but only if the variable named "var" has been
  # defined. It's like add variable, but wrap each item to quotes. The string
  # will eventually be appended to a CPack configuration file.
  ...
  # Macro that appends a SET command for the given variable name (var) to the
  # macro named strvar, but only if the variable named "var" has been set to
  # true. The string will eventually be appended to a CPack configuration file.
  ...
  macro(cpack_add_component compname)
    ...
    cmake_parse_arguments(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}
    ...
    if(NOT CPACK_MONOLITHIC_INSTALL)
      # If the user didn't set CPACK_COMPONENTS_ALL explicitly, update the value
      # of CPACK_COMPONENTS_ALL in the configuration file. This will take care
      # of any components that have been added after the CPack moduled was
      # included.
    ...
    cpack_append_string_variable_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_DISPLAY_NAME _CPACK_ADDCOMP_STR)
    cpack_append_string_variable_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_DESCRIPTION _CPACK_ADDCOMP_STR)
    cpack_append_variable_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_GROUP _CPACK_ADDCOMP_STR)
    cpack_append_variable_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_DEPENDS _CPACK_ADDCOMP_STR)
    cpack_append_variable_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_INSTALL_TYPES _CPACK_ADDCOMP_STR)
    cpack_append_string_variable_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_ARCHIVE_FILE _CPACK_ADDCOMP_STR)
    cpack_append_option_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_HIDDEN _CPACK_ADDCOMP_STR)
    cpack_append_option_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_REQUIRED _CPACK_ADDCOMP_STR)
    cpack_append_option_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_DISABLED _CPACK_ADDCOMP_STR)
    cpack_append_option_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_DOWNLOADED _CPACK_ADDCOMP_STR)
    cpack_append_string_variable_set_command(
      CPACK_COMPONENT_${_CPACK_ADDCOMP_UNAME}_PLIST _CPACK_ADDCOMP_STR)
    # Backward compatibility issue. Write to config iff the macros is used after
    # CPack.cmake has been included, other it's not necessary because the
    # variables will be encoded by cpack_encode_variables.
  ...
  macro(cpack_add_component_group grpname)
    ...
    cmake_parse_arguments(
      CPACK_COMPONENT_GROUP_${_CPACK_ADDGRP_UNAME} "EXPANDED;BOLD_TITLE"
      "DISPLAY_NAME;DESCRIPTION;PARENT_GROUP" "" ${ARGN})
    ...
    cpack_append_string_variable_set_command(
      ...
      _CPACK_ADDGRP_STR)
    cpack_append_option_set_command(
      CPACK_COMPONENT_GROUP_${_CPACK_ADDGRP_UNAME}_EXPANDED _CPACK_ADDGRP_STR)
    cpack_append_option_set_command(
  ...
  macro(cpack_configure_downloads site)
    cmake_parse_arguments(CPACK_DOWNLOAD "ALL;ADD_REMOVE;NO_ADD_REMOVE"
                          "UPLOAD_DIRECTORY" "" ${ARGN})

    set(CPACK_CONFIG_DL_STR "\n# Downloaded components configuration\n")
    set(CPACK_UPLOAD_DIRECTORY ${CPACK_DOWNLOAD_UPLOAD_DIRECTORY})
    set(CPACK_DOWNLOAD_SITE ${site})
    cpack_append_string_variable_set_command(CPACK_DOWNLOAD_SITE
                                             CPACK_CONFIG_DL_STR)
    cpack_append_string_variable_set_command(CPACK_UPLOAD_DIRECTORY
                                             CPACK_CONFIG_DL_STR)
    ...
    cpack_append_option_set_command(CPACK_ADD_REMOVE CPACK_CONFIG_DL_STR)
    # Backward compatibility issue. Write to config iff the macros is used after
    # CPack.cmake has been included, other it's not necessary because the
    # variables will be encoded by cpack_encode_variables.
    if(CPack_CMake_INCLUDED)
