...
# These are around for backwards compatibility they will be set QT_WRAP_CPP, set
# true if QT_MOC_EXECUTABLE is found QT_WRAP_UI set true if QT_UIC_EXECUTABLE is
# found
...
find_path(
  ...
  PATH_SUFFIXES lib/qt/include lib/qt3/include include/qt include/qt3
                qt/include qt3/include)

# if qglobal.h is not in the qt_include_dir then set QT_INCLUDE_DIR to NOTFOUND
if(NOT EXISTS ${QT_INCLUDE_DIR}/qglobal.h)
  set(QT_INCLUDE_DIR
      QT_INCLUDE_DIR-NOTFOUND
      CACHE PATH "path to Qt3 include directory" FORCE)
endif()

if(QT_INCLUDE_DIR)
  # extract the version string from qglobal.h
  file(STRINGS ${QT_INCLUDE_DIR}/qglobal.h QGLOBAL_H
       REGEX "#define[\t ]+QT_VERSION_STR[\t ]+\"[0-9]+.[0-9]+.[0-9]+[a-z]*\"")
  string(REGEX REPLACE ".*\"([0-9]+.[0-9]+.[0-9]+[a-z]*)\".*" "\\1"
                       qt_version_str "${QGLOBAL_H}")
  unset(QGLOBAL_H)
...
if(QT_MT_REQUIRED)
  find_library(
    QT_QT_LIBRARY
    NAMES qt-mt
          qt-mt${qt_version_str_lib}
          qt-mtnc${qt_version_str_lib}
          qt-mtedu${qt_version_str_lib}
          qt-mt230nc
          qt-mtnc321
          qt-mt3
    PATHS
...
if(WIN32)
  find_library(
    ...
    HINTS
      ...
      "[HKEY_CURRENT_USER\\Software\\Trolltech\\Qt3Versions\\3.2.0;InstallDir]"
      "[HKEY_CURRENT_USER\\Software\\Trolltech\\Qt3Versions\\3.1.0;InstallDir]"
    PATHS "$ENV{ProgramFiles}/qt" "C:/Program Files/qt"
    PATH_SUFFIXES lib
...
if(QT_UIC_EXECUTABLE)
  execute_process(
    COMMAND ${QT_UIC_EXECUTABLE} "-version"
