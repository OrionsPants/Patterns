...
if(WIN32)
  if(CYGWIN)
    ...
    find_path(
      COIN3D_INCLUDE_DIRS Inventor/So.h
    ...
    if(COIN3D_LIBRARY_DEBUG AND COIN3D_LIBRARY_RELEASE)
      set(COIN3D_LIBRARIES optimized ${COIN3D_LIBRARY_RELEASE} debug
                           ${COIN3D_LIBRARY_DEBUG})
    else()
  ...
  if(APPLE)
    ...
    set(COIN3D_LIBRARIES
        "-framework Coin3d"
        CACHE STRING "Coin3D library for OSX")
  else()
...
find_package_handle_standard_args(Coin3D DEFAULT_MSG COIN3D_LIBRARIES
                                  COIN3D_INCLUDE_DIRS)
