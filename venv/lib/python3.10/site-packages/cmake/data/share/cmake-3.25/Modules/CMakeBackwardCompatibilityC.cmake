...
if(NOT CMAKE_SKIP_COMPATIBILITY_TESTS)
  # Old CMake versions did not support OS X universal binaries anyway, so just
  # get through this with at least some size for the types.
  ...
  if("${X11_X11_INCLUDE_PATH}" STREQUAL "/usr/include")
    set(CMAKE_X_CFLAGS
        ""
        CACHE STRING "X11 extra flags.")
  else()
    set(CMAKE_X_CFLAGS
        "-I${X11_X11_INCLUDE_PATH}"
        CACHE STRING "X11 extra flags.")
  endif()
  set(CMAKE_X_LIBS
      "${X11_LIBRARIES}"
      CACHE STRING "Libraries and options used in X11 programs.")
  set(CMAKE_HAS_X
      "${X11_FOUND}"
      CACHE INTERNAL "Is X11 around.")
  ...
  set(CMAKE_USE_PTHREADS
      ...
      CACHE BOOL "Use the pthreads library.")

  set(CMAKE_USE_WIN32_THREADS
      "${CMAKE_USE_WIN32_THREADS_INIT}"
      CACHE BOOL "Use the win32 thread library.")

  set(CMAKE_HP_PTHREADS
      ${CMAKE_HP_PTHREADS_INIT}
      CACHE BOOL "Use HP pthreads.")
...
mark_as_advanced(CMAKE_HP_PTHREADS CMAKE_THREAD_LIBS CMAKE_USE_PTHREADS
                 CMAKE_USE_WIN32_THREADS CMAKE_X_CFLAGS CMAKE_X_LIBS)
