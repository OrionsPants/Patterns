...
# This file sets the basic flags for the C++ language in CMake. It also loads
# the available platform file for the system-compiler if it exists. It also
# loads a system - compiler - processor (or target hardware) specific file,
# which is mainly useful for crosscompiling and embedded systems.
...
if(CMAKE_SYSTEM_PROCESSOR)
  if(CMAKE_CXX_COMPILER_ID)
    include(
      Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_CXX_COMPILER_ID}-CXX-${CMAKE_SYSTEM_PROCESSOR}
      OPTIONAL
...
if(CMAKE_CXX_COMPILER_ID)
  include(Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_CXX_COMPILER_ID}-CXX
...
# Create a set of shared library variable specific to C++ For 90% of the
# systems, these are the same flags as the C versions so if these are not set
# just copy the flags from the c version
...
cmake_initialize_per_config_variable(CMAKE_CXX_FLAGS
...
if(NOT CMAKE_CXX_LINKER_LAUNCHER AND DEFINED ENV{CMAKE_CXX_LINKER_LAUNCHER})
  set(CMAKE_CXX_LINKER_LAUNCHER
      "$ENV{CMAKE_CXX_LINKER_LAUNCHER}"
      CACHE STRING "Linker launcher for CXX.")
endif()

include(CMakeCommonLanguageInclude)

# now define the following rules: CMAKE_CXX_CREATE_SHARED_LIBRARY
# CMAKE_CXX_CREATE_SHARED_MODULE CMAKE_CXX_COMPILE_OBJECT
...
# CXX compiler information <CMAKE_CXX_COMPILER>
# <CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS> <CMAKE_CXX_SHARED_MODULE_CREATE_FLAGS>
...
# CMAKE_CXX_CREATE_STATIC_LIBRARY is set it will override these.
