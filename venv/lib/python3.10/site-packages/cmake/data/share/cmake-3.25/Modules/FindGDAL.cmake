...
# $GDALDIR is an environment variable that would correspond to the ./configure
# --prefix=$GDAL_DIR used in building gdal.
#
# Created by Eric Wing. I'm not a gdal user, but OpenSceneGraph uses it for
# osgTerrain so I whipped this module together for completeness. I actually
# don't know the conventions or where files are typically placed in distros. Any
# real gdal users are encouraged to correct this (but please don't break the OS
# X framework stuff when doing so which is what usually seems to happen).
...
find_path(
  ...
  HINTS ENV GDAL_DIR ENV GDAL_ROOT
  PATH_SUFFIXES include/gdal include/GDAL include
  DOC "Path to the GDAL include directory")
mark_as_advanced(GDAL_INCLUDE_DIR)

if(UNIX AND NOT FindGDAL_SKIP_GDAL_CONFIG)
  # Use gdal-config to obtain the library version (this should hopefully allow
  # us to -lgdal1.x.y where x.y are correct version) For some reason, libgdal
  # development packages do not contain libgdal.so...
  find_program(
...
find_library(
  ...
  NAMES ${_gdal_lib}
        ...
        gdal1.3.2
        GDAL
  HINTS ENV GDAL_DIR ENV GDAL_ROOT ${_gdal_libpath}
  PATH_SUFFIXES lib
