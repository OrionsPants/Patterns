...
# This file is included by cmGlobalGenerator::EnableLanguage. It is included
# after the compiler has been determined, so we know things like the compiler
# name and if the compiler is gnu.

# before cmake 2.6 these variables were set in cmMakefile.cxx. This is still
# done to keep scripts and custom language and compiler modules working. But
# they are reset here and set again in the platform files for the target
# platform, so they can be used for testing the target platform instead of
# testing the host platform.
set(APPLE)
set(UNIX)
set(CYGWIN)
set(MSYS)
...
function(_cmake_record_install_prefix)
  ...
  endforeach()
  set(_CMAKE_SYSTEM_PREFIX_PATH_INSTALL_PREFIX_COUNT
      "${icount}"
      PARENT_SCOPE)
  set(_CMAKE_SYSTEM_PREFIX_PATH_STAGING_PREFIX_COUNT
      "${scount}"
      PARENT_SCOPE)
endfunction()
...
# 1. now include SystemName.cmake file to set the system specific information
set(CMAKE_SYSTEM_INFO_FILE Platform/${CMAKE_SYSTEM_NAME})

include(${CMAKE_SYSTEM_INFO_FILE} OPTIONAL
        RESULT_VARIABLE _INCLUDED_SYSTEM_INFO_FILE)
...
if(CMAKE_EXTRA_GENERATOR)
  string(REPLACE " " "" _CMAKE_EXTRA_GENERATOR_NO_SPACES
...
# variables this has to be done after the system information has been loaded
