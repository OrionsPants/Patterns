...
# find dependencies for some Qt modules when doing builds against a static Qt,
# they are required when doing builds against a shared Qt, they are not required
# if a user needs the dependencies, and they couldn't be found, they can set the
...
if(QT_QCONFIG MATCHES "x11sm")
  if(X11_SM_LIB AND X11_ICE_LIB)
    set(QT_QTGUI_LIB_DEPENDENCIES ${QT_QTGUI_LIB_DEPENDENCIES} ${X11_SM_LIB}
                                  ${X11_ICE_LIB})
  endif()
endif()
...
if(NOT Q_WS_WIN)
  ...
  if(_QT_NEED_OPENSSL)
    ...
    if(OPENSSL_LIBRARIES)
      set(QT_QTNETWORK_LIB_DEPENDENCIES ${QT_QTNETWORK_LIB_DEPENDENCIES}
                                        ${OPENSSL_LIBRARIES})
    endif()
  endif()
endif()
...
if(QT_QCONFIG MATCHES "dbus")
  ...
  if(QT_DBUS_LIBRARY)
    set(QT_QTDBUS_LIB_DEPENDENCIES ${QT_QTDBUS_LIB_DEPENDENCIES}
                                   ${QT_DBUS_LIBRARY})
  endif()
