...
if(CMAKE_OBJC_ABI_COMPILED)
  ...
  set(CMAKE_OBJC_COMPILER_WORKS TRUE)
  message(
    STATUS "Check for working OBJC compiler: ${CMAKE_OBJC_COMPILER} - skipped")
endif()

# This file is used by EnableLanguage in cmGlobalGenerator to determine that
# that selected Objective-C compiler can actually compile and link the most
# basic of programs.   If not, a fatal error is set and cmake stops processing
...
if(NOT CMAKE_OBJC_COMPILER_WORKS)
  ...
  string(
    CONCAT
      __TestCompiler_testObjCCompilerSource
      "#ifdef __cplusplus\n"
  ...
  try_compile(
    CMAKE_OBJC_COMPILER_WORKS SOURCE_FROM_VAR
    testObjCCompiler.m __TestCompiler_testObjCCompilerSource
