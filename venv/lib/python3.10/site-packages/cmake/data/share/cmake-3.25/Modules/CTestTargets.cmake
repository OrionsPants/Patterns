...
# Section 3:
#
# Custom targets to perform dashboard builds and submissions. These should NOT
# need to be modified from project to project.
#
...
# Add convenience targets.  Do this at most once in case of nested projects.
define_property(
  GLOBAL
  PROPERTY CTEST_TARGETS_ADDED
  ...
  if("${CMAKE_GENERATOR}" MATCHES "(Ninja|Make)")
    ...
    foreach(mode Nightly Experimental Continuous)
      foreach(
        ...
        set_property(TARGET ${mode}${testtype} PROPERTY FOLDER
                                                        "CTestDashboardTargets")
      endforeach()
    endforeach()
  endif()

  # If requested, add an alias that is the equivalent of the built-in "test" or
  # "RUN_TESTS" target:
