...
if(LIBXML2_INCLUDE_DIR AND EXISTS "${LIBXML2_INCLUDE_DIR}/libxml/xmlversion.h")
  ...
  string(REGEX REPLACE "^#define[\t ]+LIBXML_DOTTED_VERSION[\t ]+\"([^\"]*)\".*"
                       "\\1" LIBXML2_VERSION_STRING "${libxml2_version_str}")
...
# Did we find the same installation as pkg-config? If so, use additional
# information from it.
...
if(LibXml2_FOUND AND NOT TARGET LibXml2::LibXml2)
  ...
  set_target_properties(
    LibXml2::LibXml2 PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                "${LIBXML2_INCLUDE_DIRS}")
...
if(LIBXML2_XMLLINT_EXECUTABLE AND NOT TARGET LibXml2::xmllint)
  ...
  set_target_properties(
    LibXml2::xmllint PROPERTIES IMPORTED_LOCATION
                                "${LIBXML2_XMLLINT_EXECUTABLE}")
endif()
