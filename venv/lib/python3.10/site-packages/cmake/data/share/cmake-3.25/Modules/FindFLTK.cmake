...
set(FLTK_DIR_STRING
    "directory containing FLTKConfig.cmake.  This is either the root of the build tree, or PREFIX/lib/fltk for an installation."
)
...
if(NOT FLTK_DIR)
  ...
  find_path(
    ...
    HINTS ENV FLTK_DIR
          ...
          ${FLTK_DIR_SEARCH}
    PATH_SUFFIXES fltk fltk/include lib/fltk lib/fltk/include
...
if(FLTK_BUILT_WITH_CMAKE)
  ...
  if(FLUID_COMMAND)
    ...
    find_program(
      ...
      PATHS ${FLTK_EXECUTABLE_DIRS} ${FLTK_EXECUTABLE_DIRS}/RelWithDebInfo
            ${FLTK_EXECUTABLE_DIRS}/Debug ${FLTK_EXECUTABLE_DIRS}/Release
            NO_SYSTEM_PATH)
  endif()
  ...
  load_cache(
    ${FLTK_DIR} READ_WITH_PREFIX FL FLTK_USE_SYSTEM_JPEG FL FLTK_USE_SYSTEM_PNG
  ...
  # if FLTK was not built using CMake Find fluid executable.
