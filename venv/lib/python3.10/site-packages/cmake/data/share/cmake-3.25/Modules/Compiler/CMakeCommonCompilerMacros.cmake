...
# Check that a compiler's language standard is properly detected Parameters:
# lang   - Language to check stdver1 - Minimum version to set a given default
# for std1    - Default to use for compiler ver >= stdver1 stdverN - Minimum
# version to set a given default for stdN    - Default to use for compiler ver
# >= stdverN
#
# The order of stdverN stdN pairs passed as arguments is expected to be in
# monotonically increasing version order.
#
# Note: This macro can be called with multiple version / std pairs to convey
# that newer compiler versions may use a newer standard default.
#
# Example: To specify that compiler version 6.1 and newer defaults to C++11
# while 4.8 <= ver < 6.1 default to C++98, you would call:
#
...
macro(__compiler_check_default_language_standard lang stdver1 std1)
  ...
  # If the compiler version is below the threshold of even having CMake support
  # for language standards, then don't bother.
  if(CMAKE_${lang}_COMPILER_VERSION VERSION_GREATER_EQUAL "${stdver1}")
    if(NOT CMAKE_${lang}_COMPILER_FORCED)
      if(NOT CMAKE_${lang}_STANDARD_COMPUTED_DEFAULT
         OR NOT DEFINED CMAKE_${lang}_EXTENSIONS_COMPUTED_DEFAULT)
        message(
          FATAL_ERROR
            "CMAKE_${lang}_STANDARD_COMPUTED_DEFAULT and CMAKE_${lang}_EXTENSIONS_COMPUTED_DEFAULT should be set for ${CMAKE_${lang}_COMPILER_ID} (${CMAKE_${lang}_COMPILER}) version ${CMAKE_${lang}_COMPILER_VERSION}"
        )
      endif()
      set(CMAKE_${lang}_STANDARD_DEFAULT
          ${CMAKE_${lang}_STANDARD_COMPUTED_DEFAULT})
      set(CMAKE_${lang}_EXTENSIONS_DEFAULT
