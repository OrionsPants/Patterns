...
# available platform file for the system-compiler if it exists.
...
set(CMAKE_CSharp_FLAGS_DEBUG_INIT
    "/debug:full /optimize- /warn:3 /errorreport:prompt /define:DEBUG")
set(CMAKE_CSharp_FLAGS_RELEASE_INIT
    "/debug:none /optimize  /warn:1  /errorreport:queue")
...
if(NOT CMAKE_MODULE_EXISTS)
  ...
  set(CMAKE_SHARED_MODULE_CREATE_CSharp_FLAGS
...
cmake_initialize_per_config_variable(CMAKE_CSharp_FLAGS
                                     "Flags used by the C# compiler")

if(CMAKE_CSharp_STANDARD_LIBRARIES_INIT)
  set(CMAKE_CSharp_STANDARD_LIBRARIES
      "${CMAKE_CSharp_STANDARD_LIBRARIES_INIT}"
      CACHE STRING "Libraries linked by default with all C# applications.")
  mark_as_advanced(CMAKE_CSharp_STANDARD_LIBRARIES)
endif()

# set missing flags (if they are not defined). This is needed in the unlikely
# case that you have only C# and no C/C++ targets in your project.
cmake_initialize_per_config_variable(CMAKE_EXE_LINKER_FLAGS
