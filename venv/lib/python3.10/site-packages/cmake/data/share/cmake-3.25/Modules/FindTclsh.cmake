...
set(TCLTK_POSSIBLE_BIN_PATHS
    "${TCL_INCLUDE_PATH_PARENT}/bin" "${TK_INCLUDE_PATH_PARENT}/bin"
    "${TCL_LIBRARY_PATH_PARENT}/bin" "${TK_LIBRARY_PATH_PARENT}/bin"
...
if(TCL_TCLSH)
  execute_process(
    COMMAND "${CMAKE_COMMAND}" -E echo puts "\$tcl_version"
    COMMAND "${TCL_TCLSH}"
...
if(CMAKE_FIND_PACKAGE_NAME STREQUAL "TCL" OR CMAKE_FIND_PACKAGE_NAME STREQUAL
                                             "TclStub")
  # FindTCL include()'s this module. It's an old pattern, but rather than trying
