...
if(CMAKE_ANDROID_NDK)
  include(${CMAKE_ANDROID_NDK}/build/cmake/hooks/pre/Android-Initialize.cmake
          OPTIONAL)
endif()
...
if(CMAKE_ANDROID_NDK_TOOLCHAIN_UNIFIED)
  ...
  # CMAKE_FIND_ROOT_PATH. This is set because: 1. Users may structure their
  # libraries in a way similar to NDK. When they do that, they can simply append
  # another path to CMAKE_FIND_ROOT_PATH. 2. CMAKE_FIND_ROOT_PATH must be
  # non-empty for CMAKE_FIND_ROOT_PATH_MODE_* == ONLY to be meaningful.
  # https://github.com/android-ndk/ndk/issues/890
  list(APPEND CMAKE_FIND_ROOT_PATH
       "${CMAKE_ANDROID_NDK_TOOLCHAIN_UNIFIED}/sysroot")

  # Allow users to override these values in case they want more strict
  # behaviors. For example, they may want to prevent the NDK's libz from being
  # picked up so they can use their own.
  ...
  # Allows CMake to find headers in the architecture-specific include
  # directories.
  set(CMAKE_LIBRARY_ARCHITECTURE "${CMAKE_ANDROID_ARCH_TRIPLE}")

  # Instructs CMake to search the correct API level for libraries. Besides the
  # paths like <root>/<prefix>/lib/<arch>, cmake also searches <root>/<prefix>.
  ...
  list(APPEND CMAKE_SYSTEM_PROGRAM_PATH
       "${CMAKE_ANDROID_NDK_TOOLCHAIN_UNIFIED}/bin")
endif()
...
if(CMAKE_SYSROOT)
  ...
  message(FATAL_ERROR "Android: No CMAKE_SYSROOT was selected.")
endif()

# Include the NDK hook. It can be used by NDK to inject necessary fixes for an
# earlier cmake.
if(CMAKE_ANDROID_NDK)
  include(${CMAKE_ANDROID_NDK}/build/cmake/hooks/post/Android-Initialize.cmake
          OPTIONAL)
endif()
