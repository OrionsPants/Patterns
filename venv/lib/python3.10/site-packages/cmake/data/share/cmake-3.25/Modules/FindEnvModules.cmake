...
function(env_module)
  if(NOT EnvModules_COMMAND)
    message(
      FATAL_ERROR
        "Failed to process module command.  EnvModules_COMMAND not found")
    return()
  endif()
  ...
  cmake_parse_arguments(MOD_ARGS "${options}" "${oneValueArgs}"
                        "${multiValueArgs}" ${ARGV})
  ...
  execute_process(COMMAND mktemp -t module.cmake.XXXXXXXXXXXX
  ...
  if(MOD_ARGS_OUTPUT_VARIABLE)
    set(${MOD_ARGS_OUTPUT_VARIABLE}
        "${err_var}"
        PARENT_SCOPE)
  endif()
  if(MOD_ARGS_RESULT_VARIABLE)
    set(${MOD_ARGS_RESULT_VARIABLE}
        ${ret_var}
        PARENT_SCOPE)
  endif()
