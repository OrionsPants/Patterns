...
#
# C++ Language Specification support - Newer versions of the IAR C++ Compiler
# require the --c++ flag to build a C++ file. Earlier versions for non-ARM
# architectures provided Embedded C++, enabled with the --eec++ flag.
#
# The IAR Language Extensions - The IAR Language Extensions can be enabled by -e
# flag
#
...
if(NOT DEFINED CMAKE_CXX_COMPILER_VERSION)
  message(
    FATAL_ERROR
      "CMAKE_CXX_COMPILER_VERSION not detected. This should be automatic.")
endif()

# Whenever needed, override this default behavior using CMAKE_IAR_CXX_FLAG in
# your toolchain file.
if(NOT CMAKE_IAR_CXX_FLAG)
  ...
  if(${CMAKE_CXX_STANDARD_COMPUTED_DEFAULT} IN_LIST _CMAKE_IAR_MODERNCXX_LIST
     OR ("${CMAKE_CXX_COMPILER_ARCHITECTURE_ID}" STREQUAL "ARM"
         AND ${CMAKE_CXX_STANDARD_COMPUTED_DEFAULT} EQUAL 98))
...
if("${CMAKE_CXX_COMPILER_ARCHITECTURE_ID}" STREQUAL "ARM")
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 5)
    # IAR C++ Compiler for Arm prior version 5.xx uses XLINK. Support in CMake
    # is not implemented.
    message(
      FATAL_ERROR
        "IAR C++ Compiler for Arm version ${CMAKE_CXX_COMPILER_VERSION} not supported by CMake."
    )
  endif()
...
elseif("${CMAKE_CXX_COMPILER_ARCHITECTURE_ID}" STREQUAL "RL78")
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 2)
    # # IAR C++ Compiler for RL78 prior version 2.xx uses XLINK. Support in
    # CMake is not implemented.
    message(
      FATAL_ERROR
        "IAR C++ Compiler for RL78 version ${CMAKE_CXX_COMPILER_VERSION} not supported by CMake."
    )
  endif()
  __compiler_iar_ilink(CXX)
  __compiler_check_default_language_standard(
...
elseif("${CMAKE_CXX_COMPILER_ARCHITECTURE_ID}" STREQUAL "STM8")
  ...
  message(
    FATAL_ERROR
      "CMAKE_CXX_COMPILER_ARCHITECTURE_ID not detected. This should be automatic."
  )
endif()
