# CrayLinuxEnvironment: loaded by users cross-compiling on a Cray front-end node
# by specifying "-DCMAKE_SYSTEM_NAME=CrayLinuxEnvironment" to cmake
...
if(NOT __CrayLinuxEnvironment_message)
  set(__CrayLinuxEnvironment_message
      1
      CACHE INTERNAL "")
  if(NOT CMAKE_SYSTEM_VERSION)
    message(
      STATUS
        "CrayLinuxEnvironment: Unable to determine CLE version.  This platform file should only be used from inside the Cray Linux Environment for targeting compute nodes (NIDs)."
    )
  else()
...
# All cray systems are x86 CPUs and have been for quite some time Note: this may
# need to change in the future with 64-bit ARM
...
# Note: Some Cray's have the SYSROOT_DIR variable defined, pointing to a copy of
# the NIDs userland.  If so, then we'll use it.  Otherwise, just assume the
# userland from the login node is ok
...
list(APPEND CMAKE_SYSTEM_INCLUDE_PATH $ENV{SYSROOT_DIR}/usr/include/X11)
list(APPEND CMAKE_SYSTEM_LIBRARY_PATH $ENV{SYSROOT_DIR}/usr/local/lib64
     $ENV{SYSROOT_DIR}/usr/lib64 $ENV{SYSROOT_DIR}/lib64)
list(APPEND CMAKE_PLATFORM_IMPLICIT_LINK_DIRECTORIES
     $ENV{SYSROOT_DIR}/usr/local/lib64 $ENV{SYSROOT_DIR}/usr/lib64
