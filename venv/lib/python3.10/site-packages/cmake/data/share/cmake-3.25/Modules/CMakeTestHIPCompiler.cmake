...
if(CMAKE_HIP_ABI_COMPILED)
  ...
  set(CMAKE_HIP_COMPILER_WORKS TRUE)
  message(
    STATUS "Check for working HIP compiler: ${CMAKE_HIP_COMPILER} - skipped")
endif()
...
if(NOT CMAKE_HIP_COMPILER_WORKS)
  ...
  string(
    CONCAT __TestCompiler_testHIPCompilerSource "#ifndef __HIP__\n"
  ...
  try_compile(
    CMAKE_HIP_COMPILER_WORKS SOURCE_FROM_VAR
    testHIPCompiler.hip __TestCompiler_testHIPCompilerSource
