...
# Created by Eric Wing. Modifications by Alexander Neundorf, Ben Campbell

find_path(
  GIF_INCLUDE_DIR gif_lib.h
  HINTS ENV GIF_DIR
...
find_library(
  GIF_LIBRARY
  NAMES ${POTENTIAL_GIF_LIBS} NAMES_PER_DIR
  HINTS ENV GIF_DIR
  PATH_SUFFIXES lib)

# Very basic version detection. The GIF_LIB_VERSION string in gif_lib.h seems to
# be unreliable, since it seems to be always " Version 2.0, " in versions 3.x of
# giflib. In version 4 the member UserData was added to GifFileType, so we check
# for this one. Versions after 4.1.6 define GIFLIB_MAJOR, GIFLIB_MINOR, and
# GIFLIB_RELEASE see http://giflib.sourceforge.net/gif_lib.html#compatibility
if(GIF_INCLUDE_DIR)
  ...
  file(STRINGS ${GIF_INCLUDE_DIR}/gif_lib.h _GIF_DEFS
...
if(GIF_FOUND)
  ...
  if(NOT TARGET GIF::GIF)
    ...
    set_target_properties(GIF::GIF PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                              "${GIF_INCLUDE_DIRS}")
    if(EXISTS "${GIF_LIBRARY}")
      set_target_properties(
        GIF::GIF PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "C"
