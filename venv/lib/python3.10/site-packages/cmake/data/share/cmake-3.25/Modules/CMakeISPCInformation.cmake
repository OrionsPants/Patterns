...
if(CMAKE_ISPC_COMPILER_ID)
  ...
  if(CMAKE_SYSTEM_PROCESSOR)
    include(
      Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_ISPC_COMPILER_ID}-ISPC-${CMAKE_SYSTEM_PROCESSOR}
      OPTIONAL)
  endif()
  include(Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_ISPC_COMPILER_ID}-ISPC
          OPTIONAL)
endif()
...
cmake_initialize_per_config_variable(CMAKE_ISPC_FLAGS
                                     "Flags used by the ISPC compiler")

if(CMAKE_ISPC_STANDARD_LIBRARIES_INIT)
  set(CMAKE_ISPC_STANDARD_LIBRARIES
      "${CMAKE_ISPC_STANDARD_LIBRARIES_INIT}"
      CACHE STRING "Libraries linked by default with all ISPC applications.")
  mark_as_advanced(CMAKE_ISPC_STANDARD_LIBRARIES)
endif()

if(NOT CMAKE_ISPC_COMPILER_LAUNCHER AND DEFINED
                                        ENV{CMAKE_ISPC_COMPILER_LAUNCHER})
  set(CMAKE_ISPC_COMPILER_LAUNCHER
      "$ENV{CMAKE_ISPC_COMPILER_LAUNCHER}"
...
# now define the following rules: CMAKE_ISPC_COMPILE_OBJECT
