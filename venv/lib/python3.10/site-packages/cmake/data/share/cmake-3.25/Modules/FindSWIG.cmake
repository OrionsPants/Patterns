...
if(SWIG_FIND_VERSION_RANGE)
  foreach(_SWIG_MAJOR IN ITEMS 4 3 2)
    if(_SWIG_MAJOR VERSION_GREATER_EQUAL SWIG_FIND_VERSION_MIN_MAJOR
       AND ((SWIG_FIND_VERSION_RANGE_MAX STREQUAL "INCLUDE"
             AND _SWIG_MAJOR VERSION_LESS_EQUAL SWIG_FIND_VERSION_MAX)
            OR (SWIG_FIND_VERSION_RANGE_MAX STREQUAL "EXCLUDE"
                AND _SWIG_MAJOR VERSION_LESS SWIG_FIND_VERSION_MAX)
           ))
...
if(SWIG_EXECUTABLE AND SWIG_FIND_COMPONENTS)
  ...
  if(_swig_result)
    message(
      SEND_ERROR
        "Command \"${SWIG_EXECUTABLE} -help\" failed with output:\n${_swig_error}"
    )
  else()
    string(REPLACE "\n" ";" _swig_output "${_swig_output}")
...
find_package_handle_standard_args(
  ...
  VERSION_VAR SWIG_VERSION HANDLE_VERSION_RANGE)
