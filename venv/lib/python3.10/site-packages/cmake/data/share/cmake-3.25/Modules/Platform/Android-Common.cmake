...
if(CMAKE_ANDROID_NDK)
  ...
  if(CMAKE_ANDROID_STL_TYPE)
    list(FIND _ANDROID_STL_TYPES "${CMAKE_ANDROID_STL_TYPE}"
         _ANDROID_STL_TYPE_FOUND)
  ...
  list(APPEND CMAKE_TRY_COMPILE_PLATFORM_VARIABLES CMAKE_ANDROID_STL_TYPE)
endif()
...
if(CMAKE_ANDROID_STL_TYPE)
  if(CMAKE_ANDROID_NDK_TOOLCHAIN_UNIFIED)
    ...
    elseif(CMAKE_ANDROID_STL_TYPE STREQUAL "none")
      ...
      set(_ANDROID_STL_EXCEPTIONS 0)
      macro(__android_stl lang)
        # FIXME: Add a way to add project-wide language-specific compile-only
        # flags.
  ...
  elseif(CMAKE_ANDROID_NDK)
    ...
    macro(__android_stl_lib lang lib req)
      if(CMAKE_ANDROID_ARCH_ABI MATCHES "^armeabi" AND NOT
        ...
        set(_ANDROID_STL_LIBTHUMB
            "${_ANDROID_STL_LIBDIR}/thumb/${_ANDROID_STL_LIBNAME}")
...
# variants) to tell their build system what flags to pass for each ABI. We need
# to produce the same flags here to produce compatible binaries. We initialize
# these variables here and set them in the compiler-specific modules that
# include this one.  Then we use them in the macro below when it is called.
...
macro(__android_compiler_common lang)
  ...
  # explicitly at the end of the command-line include path so that it precedes
  # the toolchain's builtin include directories.  This is necessary so that
  # Android API-version-specific headers are preferred over those in the
  # toolchain's `include-fixed` directory (which cannot possibly match all
  # versions).
  #
  # Do not do this for a standalone toolchain because it is already tied to a
