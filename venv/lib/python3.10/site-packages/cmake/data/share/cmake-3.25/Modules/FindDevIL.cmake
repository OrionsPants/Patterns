...
# TODO: Add version support. Tested under Linux and Windows (MSVC)
...
find_package_handle_standard_args(DevIL DEFAULT_MSG IL_LIBRARIES ILU_LIBRARIES
                                  IL_INCLUDE_DIR)
...
if(DevIL_FOUND)
  ...
  if(NOT TARGET DevIL::IL)
    ...
    set_target_properties(
      DevIL::IL PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${IL_INCLUDE_DIR}"
  ...
  if(NOT TARGET DevIL::ILU)
    ...
    set_target_properties(DevIL::ILU PROPERTIES IMPORTED_LOCATION
                                                "${ILU_LIBRARIES}")
  ...
  if(NOT TARGET DevIL::ILUT AND DevIL_ILUT_FOUND)
    ...
    set_target_properties(DevIL::ILUT PROPERTIES IMPORTED_LOCATION
                                                 "${ILUT_LIBRARIES}")
