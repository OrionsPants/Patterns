...
macro(__compiler_gnu lang)
  ...
  if(NOT CMAKE_${lang}_COMPILER_VERSION VERSION_LESS 3.4)
    ...
    # Support of PIE at link stage depends on various elements : platform,
    # compiler, linker so to activate it, module CheckPIESupported must be used.
  ...
  if(CMAKE_${lang}_COMPILER_ID STREQUAL "GNU"
     AND _IN_TC
     AND NOT CMAKE_FORCE_DEPFILES)

  else()
    # distcc does not transform -o to -MT when invoking the preprocessor
    # internally, as it ought to.  Work around this bug by setting -MT here even
  ...
  set(CMAKE_${lang}_CREATE_PREPROCESSED_SOURCE
      "<CMAKE_${lang}_COMPILER> <DEFINES> <INCLUDES> <FLAGS> -E <SOURCE> > <PREPROCESSED_SOURCE>"
  )
  set(CMAKE_${lang}_CREATE_ASSEMBLY_SOURCE
      "<CMAKE_${lang}_COMPILER> <DEFINES> <INCLUDES> <FLAGS> -S <SOURCE> -o <ASSEMBLY_SOURCE>"
  )
  ...
  if(NOT CMAKE_${lang}_COMPILER_VERSION VERSION_LESS 4.5)
    ...
    # https://gcc.gnu.org/onlinedocs/gcc-9.5.0/gcc/Optimize-Options.html#Optimize-Options
    # (no) *
    # https://gcc.gnu.org/onlinedocs/gcc-10.1.0/gcc/Optimize-Options.html#Optimize-Options
    # (yes) Since GCC 12.1, the abundance of a parameter produces a warning if
    # compiling multiple targets. FIXME: What version of GCC for Windows added
    # support for -flto=auto?  10.3 does not have it.
    ...
    # Need to use version of 'ar'/'ranlib' with plugin support. Quote from
    # [documentation][1]:
    #
    # To create static libraries suitable for LTO, use gcc-ar and gcc-ranlib
    # instead of ar and ranlib
    #
  ...
  if(NOT "x${lang}" STREQUAL "xFortran")
    ...
    set(CMAKE_${lang}_COMPILE_OPTIONS_CREATE_PCH -x ${__pch_header_${lang}}
                                                 -include <PCH_HEADER>)
  endif()
  ...
  if(CMAKE_${lang}_COMPILER_VERSION VERSION_GREATER_EQUAL 4.9)
    set(CMAKE_${lang}_COMPILE_OPTIONS_COLOR_DIAGNOSTICS
