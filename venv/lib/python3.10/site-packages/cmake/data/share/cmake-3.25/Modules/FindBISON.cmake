...
if(BISON_EXECUTABLE)
  ...
  if(NOT ${BISON_version_result} EQUAL 0)
    ...
    if("${BISON_version_output}" MATCHES "^bison\\+\\+ Version ([^,]+)")
      ...
      # GNU Bison
    elseif("${BISON_version_output}" MATCHES
           "^bison \\(GNU Bison\\) ([^\n]+)\n")
      set(BISON_VERSION "${CMAKE_MATCH_1}")
  ...
  # internal macro sets BISON_TARGET_cmdopt
  ...
  # internal macro sets BISON_TARGET_output_header and BISON_TARGET_cmdopt
  ...
  # internal macro sets BISON_TARGET_verbose_file and BISON_TARGET_cmdopt
  macro(BISON_TARGET_option_report_file BisonOutput ReportFile)
    ...
    if(NOT IS_ABSOLUTE "${BISON_TARGET_verbose_file}")
      cmake_policy(
        GET CMP0088 _BISON_CMP0088 PARENT_SCOPE # undocumented, do not use
                                                # outside of CMake
      )
  ...
  # internal macro adds a custom command and sets BISON_TARGET_cmdopt,
  # BISON_TARGET_extraoutputs
  macro(BISON_TARGET_option_verbose Name BisonOutput filename)
    cmake_policy(
      GET CMP0088 _BISON_CMP0088 PARENT_SCOPE # undocumented, do not use outside
                                              # of CMake
    )
    ...
    if(NOT "${filename}" STREQUAL "")
      ...
      add_custom_command(
        OUTPUT ${BISON_TARGET_verbose_extra_file}
  ...
  macro(BISON_TARGET Name BisonInput BisonOutput)
    ...
    set(BISON_TARGET_PARAM_ONE_VALUE_KEYWORDS COMPILE_FLAGS DEFINES_FILE
                                              REPORT_FILE)
    set(BISON_TARGET_PARAM_MULTI_VALUE_KEYWORDS VERBOSE)
    cmake_parse_arguments(
      BISON_TARGET_ARG "${BISON_TARGET_PARAM_OPTIONS}"
      "${BISON_TARGET_PARAM_ONE_VALUE_KEYWORDS}"
      "${BISON_TARGET_PARAM_MULTI_VALUE_KEYWORDS}" ${ARGN})
    ...
    elseif("${BISON_TARGET_ARG_VERBOSE}" MATCHES ";")
      ...
      BISON_TARGET_option_defines("${BisonOutput}"
                                  "${BISON_TARGET_ARG_DEFINES_FILE}")
      BISON_TARGET_option_report_file("${BisonOutput}"
                                      "${BISON_TARGET_ARG_REPORT_FILE}")
