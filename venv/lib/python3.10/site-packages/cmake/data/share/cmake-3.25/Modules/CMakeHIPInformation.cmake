...
if(CMAKE_HIP_COMPILER_ID)
  ...
  if(CMAKE_SYSTEM_PROCESSOR)
    include(
      Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_HIP_COMPILER_ID}-HIP-${CMAKE_SYSTEM_PROCESSOR}
      OPTIONAL)
  endif()
...
if(CMAKE_HIP_STANDARD_LIBRARIES_INIT)
  set(CMAKE_HIP_STANDARD_LIBRARIES
      "${CMAKE_HIP_STANDARD_LIBRARIES_INIT}"
...
if(NOT CMAKE_HIP_COMPILER_LAUNCHER AND DEFINED ENV{CMAKE_HIP_COMPILER_LAUNCHER})
  set(CMAKE_HIP_COMPILER_LAUNCHER
      "$ENV{CMAKE_HIP_COMPILER_LAUNCHER}"
      CACHE STRING "Compiler launcher for HIP.")
endif()

include(CMakeCommonLanguageInclude)

# now define the following rules: CMAKE_HIP_CREATE_SHARED_LIBRARY
# CMAKE_HIP_CREATE_SHARED_MODULE CMAKE_HIP_COMPILE_OBJECT
...
if(DEFINED _CMAKE_HIP_DEVICE_RUNTIME_TARGET)
  list(APPEND CMAKE_HIP_RUNTIME_LIBRARIES_STATIC
       ${_CMAKE_HIP_DEVICE_RUNTIME_TARGET})
  list(APPEND CMAKE_HIP_RUNTIME_LIBRARIES_SHARED
       ${_CMAKE_HIP_DEVICE_RUNTIME_TARGET})
endif()
