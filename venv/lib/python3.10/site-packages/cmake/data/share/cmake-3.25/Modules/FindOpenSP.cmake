...
if(NOT OpenSP_LIBRARY)
  find_library(OpenSP_LIBRARY_RELEASE NAMES osp libosp opensp libopensp sp133
                                            libsp)

  find_library(OpenSP_LIBRARY_DEBUG NAMES ospd libospd openspd libopenspd
                                          sp133d libspd)
...
if(OpenSP_INCLUDE_DIR AND OpenSP_LIBRARY)
  if(EXISTS "${OpenSP_INCLUDE_DIR}/config.h")
    if(NOT OpenSP_VERSION)
      file(STRINGS "${OpenSP_INCLUDE_DIR}/config.h" opensp_version_str
           REGEX "^#define[\t ]+SP_VERSION[\t ]+\".*\"")
      string(REGEX REPLACE "^.*SP_VERSION[\t ]+\"([^\"]*)\".*$" "\\1"
                           OpenSP_VERSION "${opensp_version_str}")
    ...
    check_cxx_symbol_exists(SP_MULTI_BYTE "${OpenSP_INCLUDE_DIR}/config.h"
                            OpenSP_MULTI_BYTE)
  endif()
  ...
  if(NOT TARGET OpenSP::OpenSP)
    ...
    set_target_properties(
      OpenSP::OpenSP PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                "${OpenSP_INCLUDE_DIRS}")

    if(OpenSP_LIBRARY_RELEASE)
      set_target_properties(
        OpenSP::OpenSP PROPERTIES IMPORTED_LOCATION_RELEASE
                                  "${OpenSP_LIBRARY_RELEASE}")
      set_property(
    ...
    if(OpenSP_LIBRARY_DEBUG)
      set_target_properties(OpenSP::OpenSP PROPERTIES IMPORTED_LOCATION_DEBUG
                                                      "${OpenSP_LIBRARY_DEBUG}")
      set_property(
        TARGET OpenSP::OpenSP
        APPEND
    ...
    if(NOT OpenSP_LIBRARY_RELEASE AND NOT OpenSP_LIBRARY_DEBUG)
      set_property(
        TARGET OpenSP::OpenSP
        APPEND
        PROPERTY IMPORTED_LOCATION "${OpenSP_LIBRARY}")
    endif()
  endif()
endif()
