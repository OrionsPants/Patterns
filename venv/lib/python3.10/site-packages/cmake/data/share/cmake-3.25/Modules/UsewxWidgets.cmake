...
# debug message and logging. comment these out for distribution
if(NOT LOGFILE)
...
if(wxWidgets_FOUND)
  ...
  # DEPRECATED JW just for backward compatibility: add deps to all targets
  # library projects better use advanced find_package(wxWidgets) directly.
  # if(wxWidgets_LIBRARIES) link_libraries(${wxWidgets_LIBRARIES}) # BUG: str
  # too long:  MSG("wxWidgets_LIBRARIES=${wxWidgets_LIBRARIES}") if(LOGFILE)
  # file(APPEND ${LOGFILE}
