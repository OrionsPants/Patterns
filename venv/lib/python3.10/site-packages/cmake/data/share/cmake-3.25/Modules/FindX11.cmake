...
if(UNIX)
  set(X11_FOUND 0)
  # X11 is never a framework and some header files may be found in tcl on the
  # mac
  ...
  set(X11_LIB_SEARCH_PATH /usr/pkg/xorg/lib /usr/X11R6/lib /usr/X11R7/lib
                          /usr/openwin/lib /opt/X11/lib)
  ...
  find_path(X11_xcb_keysyms_INCLUDE_PATH xcb/xcb_keysyms.h
            ${X11_INC_SEARCH_PATH})
  ...
  find_path(X11_xkbcommon_INCLUDE_PATH xkbcommon/xkbcommon.h
            ${X11_INC_SEARCH_PATH})
  find_path(X11_xkbcommon_X11_INCLUDE_PATH xkbcommon/xkbcommon-x11.h
            ${X11_INC_SEARCH_PATH})
  ...
  find_path(X11_Xss_INCLUDE_PATH X11/extensions/scrnsaver.h
            ${X11_INC_SEARCH_PATH})
  ...
  if(X11_Xkb_INCLUDE_PATH
     AND X11_Xkblib_INCLUDE_PATH
     AND X11_Xlib_INCLUDE_PATH)
  ...
  # Most of the X11 headers will be in the same directories, avoid creating a
  # huge list of duplicates.
  if(X11_INCLUDE_DIR)
  ...
  if(X11_FOUND)
    ...
    # Translated from an autoconf-generated configure script. See libs.m4 in
    # autoconf's m4 directory.
    if($ENV{ISC} MATCHES "^yes$")
      ...
      check_library_exists("${X11_LIBRARIES}" "XOpenDisplay"
                           "${X11_LIBRARY_DIR}" X11_LIB_X11_SOLO)
      if(NOT X11_LIB_X11_SOLO)
        ...
        if(X11_LIB_DNET_HAS_DNET_NTOA)
          ...
          check_library_exists("dnet_stub" "dnet_ntoa" ""
    ...
    if(NOT TARGET X11::X11)
      ...
      set_target_properties(
        X11::X11
        PROPERTIES IMPORTED_LOCATION "${X11_X11_LIB}"
  ...
  if(X11_ICE_FOUND AND NOT TARGET X11::ICE)
    ...
    set_target_properties(
      X11::ICE
      PROPERTIES IMPORTED_LOCATION "${X11_ICE_LIB}"
  ...
  if(X11_SM_FOUND AND NOT TARGET X11::SM)
    ...
    set_target_properties(
      X11::SM PROPERTIES IMPORTED_LOCATION "${X11_SM_LIB}"
  ...
  if(X11_Xau_FOUND AND NOT TARGET X11::Xau)
    ...
    set_target_properties(
      X11::Xau
      PROPERTIES IMPORTED_LOCATION "${X11_Xau_LIB}"
  ...
  if(X11_Xaw_FOUND AND NOT TARGET X11::Xaw)
    ...
    set_target_properties(
      X11::Xaw
      PROPERTIES IMPORTED_LOCATION "${X11_Xaw_LIB}"
                 INTERFACE_INCLUDE_DIRECTORIES "${X11_Xaw_INCLUDE_PATH}"
                 INTERFACE_LINK_LIBRARIES
                 "X11::Xext;X11::Xmu;X11::Xt;X11::Xpm;X11::X11")
  endif()
  ...
  if(X11_xcb_FOUND AND NOT TARGET X11::xcb)
    ...
    set_target_properties(
      X11::xcb
      PROPERTIES IMPORTED_LOCATION "${X11_xcb_LIB}"
  ...
  if(X11_X11_xcb_FOUND AND NOT TARGET X11::X11_xcb)
    ...
    set_target_properties(
      X11::X11_xcb
      PROPERTIES IMPORTED_LOCATION "${X11_X11_xcb_LIB}"
  ...
  if(X11_xcb_icccm_FOUND AND NOT TARGET X11::xcb_icccm)
    ...
    set_target_properties(
      X11::xcb_icccm PROPERTIES IMPORTED_LOCATION "${X11_xcb_icccm_LIB}"
  ...
  if(X11_xcb_randr_FOUND AND NOT TARGET X11::xcb_randr)
    ...
    set_target_properties(
      X11::xcb_randr PROPERTIES IMPORTED_LOCATION "${X11_xcb_randr_LIB}"
                                INTERFACE_LINK_LIBRARIES "X11::xcb")
  endif()
  ...
  if(X11_xcb_util_FOUND AND NOT TARGET X11::xcb_util)
    ...
    set_target_properties(
      X11::xcb_util PROPERTIES IMPORTED_LOCATION "${X11_xcb_util_LIB}"
                               INTERFACE_LINK_LIBRARIES "X11::xcb")
  endif()
  ...
  if(X11_xcb_xfixes_FOUND AND NOT TARGET X11::xcb_xfixes)
    ...
    set_target_properties(
      X11::xcb_xfixes PROPERTIES IMPORTED_LOCATION "${X11_xcb_xfixes_LIB}"
                                 INTERFACE_LINK_LIBRARIES "X11::xcb")
  endif()
  ...
  if(X11_xcb_xtest_FOUND AND NOT TARGET X11::xcb_xtest)
    ...
    set_target_properties(
      X11::xcb_xtest PROPERTIES IMPORTED_LOCATION "${X11_xcb_xtest_LIB}"
                                INTERFACE_LINK_LIBRARIES "X11::xcb")
  endif()
  ...
  if(X11_xcb_keysyms_FOUND AND NOT TARGET X11::xcb_keysyms)
    ...
    set_target_properties(
      X11::xcb_keysyms PROPERTIES IMPORTED_LOCATION "${X11_xcb_keysyms_LIB}"
                                  INTERFACE_LINK_LIBRARIES "X11::xcb")
  endif()
  ...
  if(X11_xcb_xkb_FOUND AND NOT TARGET X11::xcb_xkb)
    ...
    set_target_properties(
      X11::xcb_xkb PROPERTIES IMPORTED_LOCATION "${X11_xcb_xkb_LIB}"
                              INTERFACE_LINK_LIBRARIES "X11::xcb")
  endif()
  ...
  if(X11_Xcomposite_FOUND AND NOT TARGET X11::Xcomposite)
    ...
    set_target_properties(
      X11::Xcomposite
      PROPERTIES IMPORTED_LOCATION "${X11_Xcomposite_LIB}"
  ...
  if(X11_Xcursor_FOUND AND NOT TARGET X11::Xcursor)
    ...
    set_target_properties(
      X11::Xcursor
      PROPERTIES IMPORTED_LOCATION "${X11_Xcursor_LIB}"
  ...
  if(X11_Xdamage_FOUND AND NOT TARGET X11::Xdamage)
    ...
    set_target_properties(
      X11::Xdamage
      PROPERTIES IMPORTED_LOCATION "${X11_Xdamage_LIB}"
  ...
  if(X11_Xdmcp_FOUND AND NOT TARGET X11::Xdmcp)
    ...
    set_target_properties(
      X11::Xdmcp
      PROPERTIES IMPORTED_LOCATION "${X11_Xdmcp_LIB}"
  ...
  if(X11_Xext_FOUND AND NOT TARGET X11::Xext)
    ...
    set_target_properties(
      X11::Xext
      PROPERTIES IMPORTED_LOCATION "${X11_Xext_LIB}"
  ...
  if(X11_Xxf86misc_FOUND AND NOT TARGET X11::Xxf86misc)
    ...
    set_target_properties(
      X11::Xxf86misc
      PROPERTIES IMPORTED_LOCATION "${X11_Xxf86misc_LIB}"
  ...
  if(X11_Xxf86vm_FOUND AND NOT TARGET X11::Xxf86vm)
    ...
    set_target_properties(
      X11::Xxf86vm
      PROPERTIES IMPORTED_LOCATION "${X11_Xxf86vm_LIB}"
  ...
  if(X11_Xfixes_FOUND AND NOT TARGET X11::Xfixes)
    ...
    set_target_properties(
      X11::Xfixes
      PROPERTIES IMPORTED_LOCATION "${X11_Xfixes_LIB}"
  ...
  if(X11_Xft_FOUND AND NOT TARGET X11::Xft)
    ...
    set_target_properties(
      ...
      PROPERTIES
        ...
        INTERFACE_LINK_LIBRARIES
        "X11::Xrender;X11::X11;Fontconfig::Fontconfig;Freetype::Freetype")
  endif()
  ...
  if(X11_Xi_FOUND AND NOT TARGET X11::Xi)
    ...
    set_target_properties(
      X11::Xi
      PROPERTIES IMPORTED_LOCATION "${X11_Xi_LIB}"
  ...
  if(X11_Xinerama_FOUND AND NOT TARGET X11::Xinerama)
    ...
    set_target_properties(
      X11::Xinerama
      PROPERTIES IMPORTED_LOCATION "${X11_Xinerama_LIB}"
  ...
  if(X11_Xkb_FOUND AND NOT TARGET X11::Xkb)
    ...
    set_target_properties(
      X11::Xkb
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${X11_Xkb_INCLUDE_PATH}"
                 INTERFACE_LINK_LIBRARIES "X11::X11")
  endif()
  ...
  if(X11_xkbcommon_FOUND AND NOT TARGET X11::xkbcommon)
    ...
    set_target_properties(
      X11::xkbcommon
      PROPERTIES IMPORTED_LOCATION "${X11_xkbcommon_LIB}"
  ...
  if(X11_xkbcommon_X11_FOUND AND NOT TARGET X11::xkbcommon_X11)
    ...
    set_target_properties(
      X11::xkbcommon_X11
      PROPERTIES IMPORTED_LOCATION "${X11_xkbcommon_X11_LIB}"
  ...
  if(X11_xkbfile_FOUND AND NOT TARGET X11::xkbfile)
    ...
    set_target_properties(
      X11::xkbfile
      PROPERTIES IMPORTED_LOCATION "${X11_xkbfile_LIB}"
  ...
  if(X11_Xmu_FOUND AND NOT TARGET X11::Xmu)
    ...
    set_target_properties(
      X11::Xmu
      PROPERTIES IMPORTED_LOCATION "${X11_Xmu_LIB}"
  ...
  if(X11_Xpm_FOUND AND NOT TARGET X11::Xpm)
    ...
    set_target_properties(
      X11::Xpm
      PROPERTIES IMPORTED_LOCATION "${X11_Xpm_LIB}"
  ...
  if(X11_Xtst_FOUND AND NOT TARGET X11::Xtst)
    ...
    set_target_properties(
      X11::Xtst
      PROPERTIES IMPORTED_LOCATION "${X11_Xtst_LIB}"
  ...
  if(X11_Xrandr_FOUND AND NOT TARGET X11::Xrandr)
    ...
    set_target_properties(
      X11::Xrandr
      PROPERTIES IMPORTED_LOCATION "${X11_Xrandr_LIB}"
  ...
  if(X11_Xrender_FOUND AND NOT TARGET X11::Xrender)
    ...
    set_target_properties(
      X11::Xrender
      PROPERTIES IMPORTED_LOCATION "${X11_Xrender_LIB}"
  ...
  if(X11_XRes_FOUND AND NOT TARGET X11::XRes)
    ...
    set_target_properties(
      X11::XRes
      PROPERTIES IMPORTED_LOCATION "${X11_XRes_LIB}"
  ...
  if(X11_Xss_FOUND AND NOT TARGET X11::Xss)
    ...
    set_target_properties(
      X11::Xss
      PROPERTIES IMPORTED_LOCATION "${X11_Xss_LIB}"
  ...
  if(X11_Xt_FOUND AND NOT TARGET X11::Xt)
    ...
    set_target_properties(
      X11::Xt
      PROPERTIES IMPORTED_LOCATION "${X11_Xt_LIB}"
  ...
  if(X11_Xutil_FOUND AND NOT TARGET X11::Xutil)
    ...
    set_target_properties(
      X11::Xutil
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${X11_Xutil_INCLUDE_PATH}"
                 # libX11 contains the implementations for functions in the
                 # Xutil.h
                 # header.
                 INTERFACE_LINK_LIBRARIES "X11::X11")
  endif()
  ...
  if(X11_Xv_FOUND AND NOT TARGET X11::Xv)
    ...
    set_target_properties(
      X11::Xv
      PROPERTIES IMPORTED_LOCATION "${X11_Xv_LIB}"
