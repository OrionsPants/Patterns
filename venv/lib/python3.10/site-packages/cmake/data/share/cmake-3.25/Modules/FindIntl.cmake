...
if(Intl_IS_BUILT_IN)
  ...
  find_library(
    Intl_LIBRARY
    NAMES "intl" "libintl" NAMES_PER_DIR
...
if(Intl_INCLUDE_DIR AND EXISTS "${Intl_INCLUDE_DIR}/libintl.h")
  file(STRINGS ${Intl_INCLUDE_DIR}/libintl.h Intl_VERSION_DEFINE
       REGEX "LIBINTL_VERSION (.*)")
  ...
  if(Intl_VERSION_DEFINE MATCHES "(0x[A-Fa-f0-9]+)")
    ...
    math(EXPR Intl_VERSION_MAJOR "${Intl_VERSION_NUMBER} >> 16"
         OUTPUT_FORMAT HEXADECIMAL)
    math(EXPR Intl_VERSION_MINOR
         "(${Intl_VERSION_NUMBER} - (${Intl_VERSION_MAJOR} << 16)) >> 8"
         OUTPUT_FORMAT HEXADECIMAL)
    math(
      EXPR
      Intl_VERSION_PATCH
      "${Intl_VERSION_NUMBER} - ((${Intl_VERSION_MAJOR} << 16) + (${Intl_VERSION_MINOR} << 8))"
      OUTPUT_FORMAT HEXADECIMAL)
    ...
    set(Intl_VERSION
        "${Intl_VERSION_MAJOR}.${Intl_VERSION_MINOR}.${Intl_VERSION_PATCH}")
  endif()
...
if(Intl_FOUND)
  ...
  if(NOT TARGET Intl::Intl)
    ...
    set_target_properties(
      Intl::Intl PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${Intl_INCLUDE_DIRS}"
