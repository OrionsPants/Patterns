...
# X_RESULT - name of the final result variable X_OUTPUT - name of the variable
...
macro(_ipo_run_language_check language)
  ...
  set(testdir
      "${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/_CMakeLTOTest-${language}")
  ...
  # Use: * TRY_COMPILE_PROJECT_NAME * CMAKE_VERSION
  configure_file("${try_compile_src}/CMakeLists-${language}.txt.in"
                 "${srcdir}/CMakeLists.txt" @ONLY)
  ...
  try_compile(
    _IPO_LANGUAGE_CHECK_RESULT PROJECT
    "${TRY_COMPILE_PROJECT_NAME}" SOURCE_DIR "${srcdir}" BINARY_DIR "${bindir}"
    CMAKE_FLAGS "-DCMAKE_VERBOSE_MAKEFILE=ON"
                "-DCMAKE_INTERPROCEDURAL_OPTIMIZATION=ON" ${_CMAKE_LANG_FLAGS}
...
function(check_ipo_supported)
  ...
  cmake_policy(
    GET CMP0138 ipo_CMP0138 PARENT_SCOPE # undocumented, do not use outside of
                                         # CMake
  )
  ...
  # Introduce: * X_RESULT * X_OUTPUT * X_LANGUAGES
  ...
  if(no_languages)
    ...
    if(has_unsupported)
      _ipo_not_supported("language(s) '${unsupported_languages}' not supported")
      return()
    endif()
  endif()
  ...
  foreach(lang ${languages})
    if(NOT _CMAKE_${lang}_IPO_SUPPORTED_BY_CMAKE)
      _ipo_not_supported(
        "CMake doesn't support IPO for current ${lang} compiler")
      return()
    endif()
