...
# Architecture specific C99 versions:
# https://processors.wiki.ti.com/index.php/C99_Support_in_TI_Compilers
...
if(CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL
   "${__COMPILER_TI_C99_VERSION_${CMAKE_C_COMPILER_ARCHITECTURE_ID}}")
  ...
  if(DEFINED __COMPILER_TI_C11_VERSION_${CMAKE_C_COMPILER_ARCHITECTURE_ID}
     AND CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL
         "${__COMPILER_TI_C11_VERSION_${CMAKE_C_COMPILER_ARCHITECTURE_ID}}")
