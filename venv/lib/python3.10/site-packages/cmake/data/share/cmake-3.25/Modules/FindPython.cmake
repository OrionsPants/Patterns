...
if(Python_FIND_VERSION_RANGE)
  ...
  foreach(_Python_MAJOR IN ITEMS 3 2)
    if(_Python_MAJOR VERSION_GREATER_EQUAL Python_FIND_VERSION_MIN_MAJOR
       AND ((Python_FIND_VERSION_RANGE_MAX STREQUAL "INCLUDE"
             AND _Python_MAJOR VERSION_LESS_EQUAL Python_FIND_VERSION_MAX)
            OR (Python_FIND_VERSION_RANGE_MAX STREQUAL "EXCLUDE"
                AND _Python_MAJOR VERSION_LESS Python_FIND_VERSION_MAX)
           ))
...
elseif(_Python_REQUIRED_VERSIONS)
  ...
  foreach(_Python_ITEM IN
          ITEMS Python_EXECUTABLE Python_COMPILER Python_LIBRARY
  ...
  find_package_handle_standard_args(
    ...
    VERSION_VAR
      ...
      "Version range specified \"${Python_FIND_VERSION_RANGE}\" does not include supported versions"
  )
endif()
