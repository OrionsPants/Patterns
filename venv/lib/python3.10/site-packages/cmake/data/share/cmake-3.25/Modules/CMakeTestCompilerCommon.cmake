...
function(PrintTestCompilerStatus LANG)
  ...
  # compatibility in case this function is called from project code or custom
  # toolchains (they shouldn't, but we can easily support it)
  message(
    CHECK_START
    "Check for working ${LANG} compiler: ${CMAKE_${LANG}_COMPILER}${ARGN}")
endfunction()
...
# restore the original value -- not necessary if
# __TestCompiler_setTryCompileTargetType() was used in function scope
