...
# determine the compiler to use for Fortran programs NOTE, a generator may set
# CMAKE_Fortran_COMPILER before loading this file to force a compiler. use
# environment variable FC first if defined by user, next use the cmake variable
# CMAKE_GENERATOR_FC which can be defined by a generator as a default compiler
...
elseif("${CMAKE_GENERATOR}" MATCHES "Xcode")
  ...
  if(NOT CMAKE_Fortran_COMPILER)
    ...
    if(NOT $ENV{FC} STREQUAL "")
      get_filename_component(CMAKE_Fortran_COMPILER_INIT $ENV{FC} PROGRAM
                             PROGRAM_ARGS CMAKE_Fortran_FLAGS_ENV_INIT)
      if(CMAKE_Fortran_FLAGS_ENV_INIT)
        set(CMAKE_Fortran_COMPILER_ARG1
            "${CMAKE_Fortran_FLAGS_ENV_INIT}"
            CACHE STRING "Arguments to Fortran compiler")
      endif()
    ...
    if(NOT CMAKE_Fortran_COMPILER_INIT)
      # Known compilers: ftn: Cray fortran compiler wrapper gfortran: putative
      # GNU Fortran 95+ compiler (in progress) frt: Fujitsu Fortran compiler
      # pathf90/pathf95/pathf2003: PathScale Fortran compiler pgfortran:
      # Portland Group Fortran compilers nvfortran: NVHPC Fotran compiler flang:
      # Flang Fortran compiler xlf: IBM (AIX) Fortran compiler lf95:
      # Lahey-Fujitsu F95 compiler fl32: Microsoft Fortran 77 "PowerStation"
      # compiler af77: Apogee F77 compiler for Intergraph hardware running CLIX
      # epcf90: "Edinburgh Portable Compiler" F90 fort: Compaq (now HP) Fortran
      # 90/95 compiler for Tru64 and Linux/Alpha ifx: Intel Fortran LLVM-based
      # compiler ifort: Intel Classic Fortran compiler nagfor: NAG Fortran
      # compiler
      #
      # GNU is last to be searched, so if you paid for a compiler it is picked
      # by default.
  ...
  # Each entry in this list is a set of extra flags to try adding to the compile
  # line to see if it helps produce a valid identification executable.
  set(CMAKE_Fortran_COMPILER_ID_TEST_FLAGS_FIRST # Get verbose output to help
                                                 # distinguish compilers.
      "-v")
...
if(NOT CMAKE_Fortran_COMPILER_ID_RUN)
  ...
  set(CMAKE_Fortran_COMPILER_ID_MATCH_VENDOR_REGEX_CCur
      "Concurrent Fortran [0-9]+ Compiler")

  # Table of per-vendor compiler id flags with expected output.
  list(APPEND CMAKE_Fortran_COMPILER_ID_VENDORS Compaq)
  set(CMAKE_Fortran_COMPILER_ID_VENDOR_FLAGS_Compaq "-what")
  set(CMAKE_Fortran_COMPILER_ID_VENDOR_REGEX_Compaq "Compaq Visual Fortran")
  list(APPEND CMAKE_Fortran_COMPILER_ID_VENDORS NAG) # Numerical Algorithms
                                                     # Group
  set(CMAKE_Fortran_COMPILER_ID_VENDOR_FLAGS_NAG "-V")
  set(CMAKE_Fortran_COMPILER_ID_VENDOR_REGEX_NAG "NAG Fortran Compiler")

  # Match the link line from xcodebuild output of the form Ld ... ...
  # /path/to/cc ...CompilerIdFortran/... to extract the compiler front-end for
  # the language.
...
")
  ...
  if(NOT CMAKE_Fortran_COMPILER_ID)
    execute_process(
      COMMAND ${CMAKE_Fortran_COMPILER} ${CMAKE_Fortran_COMPILER_ID_FLAGS_LIST}
              -E "${CMAKE_ROOT}/Modules/CMakeTestGNU.c"
  ...
  # Fall back for GNU MINGW, which is not always detected correctly (__MINGW32__
  # is defined for the C language, but perhaps not for Fortran!)
...
# if we have a fortran cross compiler, they have usually some prefix, like e.g.
# powerpc-linux-gfortran, arm-elf-gfortran or i586-mingw32msvc-gfortran ,
# optionally with a 3-component version number at the end (e.g.
# arm-eabi-gcc-4.5.2). The other tools of the toolchain usually have the same
# prefix NAME_WE cannot be used since then this test will fail for names like
...
if(NOT _CMAKE_TOOLCHAIN_PREFIX)
  ...
  if(CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
    ...
    # own binutils but uses the regular ar, objcopy, etc. (instead of
    # llvm-objcopy etc.)
...
configure_file(${CMAKE_ROOT}/Modules/CMakeFortranCompiler.cmake.in
               ${CMAKE_PLATFORM_INFO_DIR}/CMakeFortranCompiler.cmake @ONLY)
