...
function(__check_type_size_impl type var map builtin language)
  ...
  if(HAVE_${var})
    ...
    if(mismatch AND keys)
      configure_file(${__check_type_size_dir}/CheckTypeSizeMap.cmake.in ${map}
                     @ONLY)
      set(${var} 0)
    else()
      file(REMOVE ${map})
    ...
    set(${var}
        "${${var}}"
        CACHE INTERNAL "CHECK_TYPE_SIZE: sizeof(${type})")
  else()
    ...
    set(${var}
        ""
        CACHE INTERNAL "CHECK_TYPE_SIZE: ${type} unknown")
    file(REMOVE ${map})
  endif()
endfunction()
...
macro(CHECK_TYPE_SIZE TYPE VARIABLE)
  ...
  set(${VARIABLE}_KEYS)
  set(_map_file
      ${CMAKE_BINARY_DIR}/${CMAKE_FILES_DIRECTORY}/CheckTypeSize/${VARIABLE}.cmake
  )
