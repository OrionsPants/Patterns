...
# This file is included by CMakeFindEclipseCDT4.cmake and
# CMakeFindCodeBlocks.cmake

# The Eclipse and the CodeBlocks generators need to know the standard include
# path so that they can find the headers at runtime and parsing etc. works
# better This is done here by actually running gcc with the options so it prints
# its system include directories, which are parsed then and stored in the cache.
macro(_DETERMINE_GCC_SYSTEM_INCLUDE_DIRS _lang _resultIncludeDirs
      _resultDefines)
  ...
  execute_process(
    COMMAND ${_compilerExecutable} ${_arg1} ${_stdver} ${_stdlib} -v -E -x
            ${_lang} -dD dummy
  ...
  # A few example lines which the regexp below has to match properly: #define
  # MAX(a,b) ((a) > (b) ? (a) : (b)) #define __fastcall
  # __attribute__((__fastcall__)) #define   FOO (23) #define __UINTMAX_TYPE__
  # long long unsigned int #define __UINTMAX_TYPE__ long long unsigned int
  # #define __i386__  1
  ...
  foreach(nextLine ${_defineLines})
    ...
    # message(STATUS "m1: -${CMAKE_MATCH_1}- m2: -${CMAKE_MATCH_2}- m3:
    # -${CMAKE_MATCH_3}-")
...
# them to "C" that way GCC's "search starts here" text is in English and we can
# grok it.
...
if(NOT CMAKE_EXTRA_GENERATOR_C_SYSTEM_INCLUDE_DIRS)
  if(CMAKE_C_COMPILER_ID MATCHES GNU
    ...
    set(CMAKE_EXTRA_GENERATOR_C_SYSTEM_DEFINED_MACROS
        "${_defines}"
        CACHE INTERNAL "C compiler system defined macros")
...
if(NOT CMAKE_EXTRA_GENERATOR_CXX_SYSTEM_INCLUDE_DIRS)
  if("${CMAKE_CXX_COMPILER_ID}" MATCHES GNU
     OR "${CMAKE_CXX_COMPILER_ID}" MATCHES "LCC"
    ...
    set(CMAKE_EXTRA_GENERATOR_CXX_SYSTEM_DEFINED_MACROS
        "${_defines}"
        CACHE INTERNAL "CXX compiler system defined macros")
