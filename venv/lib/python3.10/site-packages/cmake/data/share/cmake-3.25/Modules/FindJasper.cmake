...
if(JASPER_INCLUDE_DIR AND EXISTS "${JASPER_INCLUDE_DIR}/jasper/jas_config.h")
  file(STRINGS "${JASPER_INCLUDE_DIR}/jasper/jas_config.h" jasper_version_str
       REGEX "^#define[\t ]+JAS_VERSION[\t ]+\".*\".*")
  ...
  if(NOT TARGET Jasper::Jasper)
    ...
    if(JASPER_INCLUDE_DIRS)
      set_target_properties(
        Jasper::Jasper PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                  "${JASPER_INCLUDE_DIRS}")
    endif()
    if(EXISTS "${JASPER_LIBRARY_RELEASE}")
      set_property(
        ...
        APPEND
        PROPERTY IMPORTED CONFIGURATION RELEASE)
      set_target_properties(
        Jasper::Jasper PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
    ...
    if(EXISTS "${JASPER_LIBRARY_DEBUG}")
      set_property(
        TARGET Jasper::Jasper
        APPEND
        PROPERTY IMPORTED CONFIGURATION DEBUG)
      set_target_properties(
        Jasper::Jasper PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
