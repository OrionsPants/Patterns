...
# "CMakeSystemSpecificInformation.cmake" already included it. The extra
# inclusion is a work-around documented next to the include() call, so this can
# be removed when the work-around is removed.
if(__WINDOWS_PATHS_INCLUDED)
  return()
endif()
set(__WINDOWS_PATHS_INCLUDED 1)

# Add the program-files folder(s) to the list of installation prefixes.
#
# Windows 64-bit Binary: ENV{ProgramFiles(x86)} = [C:\Program Files (x86)]
# ENV{ProgramFiles} = [C:\Program Files] ENV{ProgramW6432} = [C:\Program Files]
# or <not set>
#
# Windows 32-bit Binary on 64-bit Windows: ENV{ProgramFiles(x86)} = [C:\Program
# Files (x86)] ENV{ProgramFiles} = [C:\Program Files (x86)] ENV{ProgramW6432} =
# [C:\Program Files]
#
# Reminder when adding new locations computed from environment variables please
# make sure to keep Help/variable/CMAKE_SYSTEM_PREFIX_PATH.rst synchronized
set(_programfiles "")
...
list(APPEND CMAKE_SYSTEM_LIBRARY_PATH "${_CMAKE_INSTALL_DIR}/bin" /bin)
