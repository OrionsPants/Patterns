...
macro(PKGCONFIG _package _include_DIR _link_DIR _link_FLAGS _cflags)
  ...
  if(PKGCONFIG_EXECUTABLE)
    ...
    if(NOT _return_VALUE)
      ...
      exec_program(
        ${PKGCONFIG_EXECUTABLE} ARGS
        ${_package} --variable=includedir
        OUTPUT_VARIABLE ${_include_DIR})
      string(REGEX REPLACE "[\r\n]" " " ${_include_DIR} "${${_include_DIR}}")

      exec_program(
        ${PKGCONFIG_EXECUTABLE} ARGS
        ${_package} --variable=libdir
      ...
      message(
        STATUS
          "PKGCONFIG() indicates that ${_package} is not installed (install the package which contains ${_package}.pc if you want to support this feature)"
      )
