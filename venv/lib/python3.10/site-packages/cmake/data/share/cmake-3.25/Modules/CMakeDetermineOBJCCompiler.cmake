...
# set CMAKE_OBJC_COMPILER before loading this file to force a compiler. use
# environment variable OBJC first if defined by user, next use the cmake
# variable CMAKE_GENERATOR_OBJC which can be defined by a generator as a default
# compiler
#
# Sets the following variables: CMAKE_OBJC_COMPILER CMAKE_AR CMAKE_RANLIB
# CMAKE_COMPILER_IS_GNUOBJC CMAKE_COMPILER_IS_CLANGOBJC
#
...
if("${CMAKE_GENERATOR}" MATCHES "Xcode")
  ...
  if(NOT CMAKE_OBJC_COMPILER)
    ...
    foreach(var OBJC CC)
      if($ENV{${var}} MATCHES ".+")
        get_filename_component(CMAKE_OBJC_COMPILER_INIT $ENV{${var}} PROGRAM
                               PROGRAM_ARGS CMAKE_OBJC_FLAGS_ENV_INIT)
        if(CMAKE_OBJC_FLAGS_ENV_INIT)
          set(CMAKE_OBJC_COMPILER_ARG1
              "${CMAKE_OBJC_FLAGS_ENV_INIT}"
    ...
    if(NOT CMAKE_OBJC_COMPILER_INIT)
      set(CMAKE_OBJC_COMPILER_LIST ${_CMAKE_TOOLCHAIN_PREFIX}cc
                                   ${_CMAKE_TOOLCHAIN_PREFIX}gcc clang)
    endif()

    _cmake_find_compiler(OBJC)

  else()
    # we only get here if CMAKE_OBJC_COMPILER was specified using -D or a
    # pre-made CMakeCache.txt (e.g. via ctest) or set in CMAKE_TOOLCHAIN_FILE if
    # CMAKE_OBJC_COMPILER is a list, use the first item as CMAKE_OBJC_COMPILER
    # and the rest as CMAKE_OBJC_COMPILER_ARG1
    ...
    # compiler
    get_filename_component(_CMAKE_USER_OBJC_COMPILER_PATH
                           "${CMAKE_OBJC_COMPILER}" PATH)
  ...
  set(CMAKE_OBJC_COMPILER_ID_TEST_FLAGS # Try compiling to an object file only.
      "-c")
endif()
...
if(NOT CMAKE_OBJC_COMPILER_ID_RUN)
  ...
  # /path/to/cc ...CompilerIdOBJC/... to extract the compiler front-end for the
  # language.
...
if(NOT _CMAKE_TOOLCHAIN_LOCATION)
  get_filename_component(_CMAKE_TOOLCHAIN_LOCATION "${CMAKE_OBJC_COMPILER}"
                         PATH)
endif()

# If we have a gcc cross compiler, they have usually some prefix, like e.g.
# powerpc-linux-gcc, arm-elf-gcc or i586-mingw32msvc-gcc, optionally with a
...
if(CMAKE_CROSSCOMPILING AND NOT _CMAKE_TOOLCHAIN_PREFIX)
  ...
  if(CMAKE_OBJC_COMPILER_ID MATCHES "GNU|Clang|QCC")
    ...
    elseif(COMPILER_BASENAME MATCHES "qcc(\\.exe)?$")
      if(CMAKE_OBJC_COMPILER_TARGET MATCHES
...
configure_file(${CMAKE_ROOT}/Modules/CMakeOBJCCompiler.cmake.in
               ${CMAKE_PLATFORM_INFO_DIR}/CMakeOBJCCompiler.cmake @ONLY)
