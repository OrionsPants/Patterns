...
if(LibArchive_INCLUDE_DIR AND EXISTS "${LibArchive_INCLUDE_DIR}/archive.h")
  ...
  # #define ARCHIVE_LIBRARY_VERSION "libarchive 2.4.12" #define
  # ARCHIVE_VERSION_STRING "libarchive 2.8.4" #define
  # ARCHIVE_VERSION_ONLY_STRING "3.2.0" Match any format.
  set(_LibArchive_VERSION_REGEX
      "^#define[ \t]+ARCHIVE[_A-Z]+VERSION[_A-Z]*[ \t]+\"(libarchive +)?([0-9]+)\\.([0-9]+)\\.([0-9]+)[^\"]*\".*$"
  )
  file(
    STRINGS "${LibArchive_INCLUDE_DIR}/archive.h" _LibArchive_VERSION_STRING
    LIMIT_COUNT 1
    REGEX "${_LibArchive_VERSION_REGEX}")
  if(_LibArchive_VERSION_STRING)
    string(REGEX REPLACE "${_LibArchive_VERSION_REGEX}" "\\2.\\3.\\4"
                         LibArchive_VERSION "${_LibArchive_VERSION_STRING}")
  endif()
...
if(LibArchive_FOUND)
  ...
  if(NOT TARGET LibArchive::LibArchive)
    ...
    set_target_properties(
      ...
      PROPERTIES IMPORTED_LOCATION "${LibArchive_LIBRARY}"
