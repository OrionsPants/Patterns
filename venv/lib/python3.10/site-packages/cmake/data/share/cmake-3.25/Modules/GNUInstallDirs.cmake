...
if(NOT DEFINED CMAKE_INSTALL_LIBDIR
  ...
  # NOT cross-compiling - we are NOT on debian - we are NOT building for conda -
  # we are on a 64 bits system reason is: amd64 ABI:
  # https://github.com/hjl-tools/x86-psABI/wiki/X86-psABI For Debian with
  # multiarch, use 'lib/${CMAKE_LIBRARY_ARCHITECTURE}' if
  ...
  if(CMAKE_SYSTEM_NAME MATCHES "^(Linux|kFreeBSD|GNU)$"
    ...
    elseif(DEFINED ENV{CONDA_PREFIX})
      ...
      cmake_path(ABSOLUTE_PATH conda_prefix NORMALIZE)
      if("${CMAKE_INSTALL_PREFIX}" STREQUAL conda_prefix
         AND NOT ("${CMAKE_INSTALL_PREFIX}" MATCHES "^/usr/?$"
...
macro(GNUInstallDirs_get_absolute_install_dir absvar var)
  ...
  if(NOT IS_ABSOLUTE "${${var}}")
    ...
    if("${CMAKE_INSTALL_PREFIX}" STREQUAL "/")
      if("${GGAID_dir}" STREQUAL "SYSCONFDIR"
         OR "${GGAID_dir}" STREQUAL "LOCALSTATEDIR"
         OR "${GGAID_dir}" STREQUAL "RUNSTATEDIR")
        set(${absvar} "/${${var}}")
      else()
    ...
    elseif("${CMAKE_INSTALL_PREFIX}" MATCHES "^/opt/"
           AND NOT "${CMAKE_INSTALL_PREFIX}" MATCHES "^/opt/homebrew/")
      if("${GGAID_dir}" STREQUAL "SYSCONFDIR"
         OR "${GGAID_dir}" STREQUAL "LOCALSTATEDIR"
         OR "${GGAID_dir}" STREQUAL "RUNSTATEDIR")
