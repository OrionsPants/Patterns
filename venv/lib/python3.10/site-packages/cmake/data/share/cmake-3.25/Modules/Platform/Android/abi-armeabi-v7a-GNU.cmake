...
string(APPEND _ANDROID_ABI_INIT_CFLAGS " -march=armv7-a")
...
string(APPEND _ANDROID_ABI_INIT_CFLAGS " -mfloat-abi=softfp")

string(APPEND _ANDROID_ABI_INIT_LDFLAGS " -Wl,--fix-cortex-a8")
