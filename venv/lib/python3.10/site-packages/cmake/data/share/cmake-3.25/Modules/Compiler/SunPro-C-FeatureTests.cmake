...
set(SunPro_C11
    "${_cmake_oldestSupported} && defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L || __STDC_VERSION__ >= 199901L && defined(__C11FEATURES__))"
)
set(_cmake_feature_test_c_static_assert "${SunPro_C11}")
unset(SunPro_C11)

set(SunPro_C99
    "${_cmake_oldestSupported} && defined(__STDC_VERSION__) && __STDC_VERSION__ >= 199901L"
)
