...
if(NOT DEFINED CMAKE_JOB_POOL_LINK
   OR NOT DEFINED CMAKE_JOB_POOL_COMPILE
   OR NOT DEFINED CMAKE_JOB_POOL_PRECOMPILE_HEADER)
...
# The link flags for PGI are the raw filename to add a file and the UNIX -L
# syntax to link directories.
...
macro(__windows_compiler_pgi lang)
  ...
  set(CMAKE_${lang}_CREATE_STATIC_LIBRARY
      "lib ${CMAKE_CL_NOLOGO} <LINK_FLAGS> /out:<TARGET> <OBJECTS> ")
  set(CMAKE_${lang}_CREATE_SHARED_LIBRARY
      "<CMAKE_${lang}_COMPILER> ${CMAKE_START_TEMP_FILE} -Mmakedll -implib:<TARGET_IMPLIB> -Xlinker -pdb:<TARGET_PDB> -Xlinker -version:<TARGET_VERSION_MAJOR>.<TARGET_VERSION_MINOR> <LINK_FLAGS> -o <TARGET> <OBJECTS> <LINK_LIBRARIES> ${CMAKE_END_TEMP_FILE}"
  )
