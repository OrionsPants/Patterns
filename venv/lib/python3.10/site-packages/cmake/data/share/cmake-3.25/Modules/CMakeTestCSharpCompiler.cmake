...
# selected C# compiler can actually compile and link the most basic of programs.
# If not, a fatal error is set and cmake stops processing commands and will not
# generate any makefiles or projects.
if(NOT CMAKE_CSharp_COMPILER_WORKS)
  # Don't call PrintTestCompilerStatus() because the "C#" we want to pass as the
  # LANG doesn't match with the variable name "CMAKE_CSharp_COMPILER"
  message(CHECK_START "Check for working C# compiler: ${CMAKE_CSharp_COMPILER}")
  string(CONCAT __TestCompiler_testCSharpCompilerSource "namespace Test {\n"
                "   public class CSharp {\n"
  ...
  try_compile(
    CMAKE_CSharp_COMPILER_WORKS SOURCE_FROM_VAR
    testCSharpCompiler.cs __TestCompiler_testCSharpCompilerSource
...
if(NOT CMAKE_CSharp_COMPILER_WORKS)
  ...
  configure_file(${CMAKE_ROOT}/Modules/CMakeCSharpCompiler.cmake.in
                 ${CMAKE_PLATFORM_INFO_DIR}/CMakeCSharpCompiler.cmake @ONLY)
