...
macro(__linux_compiler_intel lang)
  ...
  # We pass this for historical reasons.  Projects may have executables that use
  # dlopen but do not set ENABLE_EXPORTS.
  ...
  if(XIAR)
    ...
    set(CMAKE_${lang}_CREATE_STATIC_LIBRARY_IPO
        "${XIAR} cr <TARGET> <LINK_FLAGS> <OBJECTS> " "${XIAR} -s <TARGET> ")
