...
if(CMAKE_ANDROID_NDK)
  include(${CMAKE_ANDROID_NDK}/build/cmake/hooks/pre/Determine-Compiler.cmake
          OPTIONAL)
endif()
...
macro(__android_determine_compiler lang)
  if(_ANDROID_TOOL_${lang}_COMPILER)
    ...
    set(CMAKE_${lang}_COMPILER_EXTERNAL_TOOLCHAIN
        "${_ANDROID_TOOL_${lang}_COMPILER_EXTERNAL_TOOLCHAIN}")
...
# earlier cmake.
if(CMAKE_ANDROID_NDK)
  include(${CMAKE_ANDROID_NDK}/build/cmake/hooks/post/Determine-Compiler.cmake
          OPTIONAL)
endif()
