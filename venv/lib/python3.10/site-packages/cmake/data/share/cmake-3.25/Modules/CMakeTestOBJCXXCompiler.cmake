...
cmake_determine_compiler_abi(OBJCXX
                             ${CMAKE_ROOT}/Modules/CMakeOBJCXXCompilerABI.mm)
if(CMAKE_OBJCXX_ABI_COMPILED)
  # The compiler worked so skip dedicated test below.
  set(CMAKE_OBJCXX_COMPILER_WORKS TRUE)
  message(
    STATUS
      "Check for working OBJCXX compiler: ${CMAKE_OBJCXX_COMPILER} - skipped")
endif()

# This file is used by EnableLanguage in cmGlobalGenerator to determine that the
# selected Objective-C++ compiler can actually compile and link the most basic
# of programs.   If not, a fatal error is set and cmake stops processing
# commands and will not generate any makefiles or projects.
if(NOT CMAKE_OBJCXX_COMPILER_WORKS)
  PrintTestCompilerStatus("OBJCXX")
  __testcompiler_settrycompiletargettype()
  string(
    CONCAT
      __TestCompiler_testObjCXXCompilerSource
      "#ifndef __cplusplus\n"
  ...
  try_compile(
    CMAKE_OBJCXX_COMPILER_WORKS SOURCE_FROM_VAR
    testObjCXXCompiler.mm __TestCompiler_testObjCXXCompilerSource
