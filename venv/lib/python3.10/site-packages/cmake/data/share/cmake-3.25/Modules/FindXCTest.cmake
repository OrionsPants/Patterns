...
if(CMAKE_EFFECTIVE_SYSTEM_NAME STREQUAL "Apple" AND NOT CMAKE_SYSTEM_NAME
                                                    STREQUAL "Darwin")
  # Non-macos systems set the CMAKE_FIND_ROOT_PATH_MODE to "ONLY" which
  # restricts the search paths too much to find XCTest.framework. In contrast to
  # the regular system frameworks which reside within the SDK direectory the
  # XCTest framework is located in the respective platform directory which is
  # not added to the CMAKE_FIND_ROOT_PATH (only to CMAKE_SYSTEM_FRAMEWORK_PATH)
  # and therefore not searched.
  #
  # Until this is properly addressed, temporaily add the platform directory to
...
if(_xcrun_out)
  set(XCTest_EXECUTABLE
      "${_xcrun_out}"
      CACHE FILEPATH "XCTest executable")
...
function(xctest_add_bundle target testee)
  ...
  if(NOT CMAKE_OSX_SYSROOT)
    message(
      FATAL_ERROR "Adding XCTest bundles requires CMAKE_OSX_SYSROOT to be set.")
  endif()
  ...
  elseif(_testee_type STREQUAL "EXECUTABLE" AND _testee_macosx_bundle)
    ...
    if(XCODE)
      set_target_properties(
        ${target}
        PROPERTIES XCODE_ATTRIBUTE_BUNDLE_LOADER "$(TEST_HOST)"
...
function(xctest_add_test name bundle)
  ...
  add_test(NAME ${name} COMMAND ${XCTest_EXECUTABLE}
  ...
  if(_testee_type STREQUAL "SHARED_LIBRARY" AND _testee_framework)
    set_property(
      ...
      PROPERTY ENVIRONMENT
               DYLD_FRAMEWORK_PATH=$<TARGET_LINKER_FILE_DIR:${_testee}>/..)
  endif()
