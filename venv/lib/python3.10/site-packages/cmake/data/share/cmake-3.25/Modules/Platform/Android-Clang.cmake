...
if(CMAKE_ANDROID_NDK)
  include(${CMAKE_ANDROID_NDK}/build/cmake/hooks/pre/Android-Clang.cmake
          OPTIONAL)
endif()

# Load flags from NDK. This file may provides the following variables:
# _ANDROID_NDK_INIT_CFLAGS _ANDROID_NDK_INIT_CFLAGS_DEBUG
# _ANDROID_NDK_INIT_CFLAGS_RELEASE _ANDROID_NDK_INIT_LDFLAGS
...
# functionality for now.  Later we may try to integrate this.
...
# earlier cmake.
if(CMAKE_ANDROID_NDK)
  include(${CMAKE_ANDROID_NDK}/build/cmake/hooks/post/Android-Clang.cmake
          OPTIONAL)
endif()
