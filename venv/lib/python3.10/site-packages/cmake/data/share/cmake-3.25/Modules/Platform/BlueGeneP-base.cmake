...
#
# NOTE: Do not set your platform to "BlueGeneP-base".  This file is included by
# the real platform files.  Use one of these two platforms instead:
#
# BlueGeneP-dynamic  For dynamically linked builds BlueGeneP-static   For
...
# the system directories so that the various system BGP CNK library locations
# are searched first.  This is not the clearest thing in the world, given IBM's
...
set(CMAKE_SYSTEM_LIBRARY_PATH
    /bgsys/drivers/ppcfloor/comm/default/lib # default comm layer (used by mpi
                                             # compiler wrappers)
    /bgsys/drivers/ppcfloor/comm/sys/lib # DCMF, other lower-level comm
                                         # libraries
    ...
    /bgsys/drivers/ppcfloor/gnu-linux/powerpc-bgp-linux/lib # CNK Linux image --
                                                            # standard runtime
                                                            # libs, pthread,
                                                            # etc.
)
...
# compiles. Most of these directories are the includeand lib directories for the
# frontend on BG/P systems. Not ignoring these can cause things like FindX11 to
# find a frontend PPC version mistakenly. We use this on BG instead of
# re-rooting because backend libraries are typically strewn about the
...
# BGP, We can't support both static and dynamic links in the same platform file.
