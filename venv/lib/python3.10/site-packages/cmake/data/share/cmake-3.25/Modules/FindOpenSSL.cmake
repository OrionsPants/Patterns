  ...
  if(WIN32 AND OPENSSL_USE_STATIC_LIBS)
    if(WINCE)
      set_property(
        TARGET ${target}
        APPEND
        PROPERTY INTERFACE_LINK_LIBRARIES ws2)
    else()
      set_property(
        TARGET ${target}
        APPEND
...
if(CMAKE_SYSTEM_NAME STREQUAL "QNX"
   AND CMAKE_SYSTEM_VERSION VERSION_GREATER_EQUAL "7.0"
   AND CMAKE_SYSTEM_VERSION VERSION_LESS "7.1"
   AND OpenSSL_FIND_VERSION VERSION_GREATER_EQUAL "1.1"
   AND OpenSSL_FIND_VERSION VERSION_LESS "1.2")
  # QNX 7.0.x provides openssl 1.0.2 and 1.1.1 in parallel: * openssl 1.0.2:
  # libcrypto.so.2 and libssl.so.2, headers under usr/include/openssl * openssl
  # 1.1.1: libcrypto1_1.so.2.1 and libssl1_1.so.2.1, header under
  # usr/include/openssl1_1 See
  # http://www.qnx.com/developers/articles/rel_6726_0.html
...
if(WIN32 AND NOT CYGWIN)
  ...
  elseif(MINGW)
    ...
    find_library(
      ...
      PATH_SUFFIXES "lib/MinGW" "lib" "lib64")
  ...
  find_library(
    OPENSSL_SSL_LIBRARY
    NAMES ssl${_OPENSSL_NAME_POSTFIX} ssleay32 ssleay32MD NAMES_PER_DIR
          ${_OPENSSL_ROOT_HINTS_AND_PATHS}
  ...
  find_library(
    OPENSSL_CRYPTO_LIBRARY
    NAMES crypto${_OPENSSL_NAME_POSTFIX} NAMES_PER_DIR
          ${_OPENSSL_ROOT_HINTS_AND_PATHS}
    HINTS ${_OPENSSL_LIBDIR} ${_OPENSSL_LIBRARY_DIRS}
    PATH_SUFFIXES lib lib64)
...
if(OPENSSL_INCLUDE_DIR AND EXISTS "${OPENSSL_INCLUDE_DIR}/openssl/opensslv.h")
  ...
  if(openssl_version_str)
    ...
    # Setting OPENSSL_VERSION_MAJOR OPENSSL_VERSION_MINOR and
    # OPENSSL_VERSION_FIX
    string(REGEX MATCHALL "([0-9])+" OPENSSL_VERSION_NUMBER
                 "${OPENSSL_VERSION}")
    list(POP_FRONT OPENSSL_VERSION_NUMBER OPENSSL_VERSION_MAJOR
         OPENSSL_VERSION_MINOR OPENSSL_VERSION_FIX)
...
if(OPENSSL_FOUND)
  ...
  if("${OPENSSL_VERSION_MAJOR}.${OPENSSL_VERSION_MINOR}.${OPENSSL_VERSION_FIX}"
