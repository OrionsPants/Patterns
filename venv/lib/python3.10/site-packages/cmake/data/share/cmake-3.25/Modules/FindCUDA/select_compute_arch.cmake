# Synopsis: CUDA_SELECT_NVCC_ARCH_FLAGS(out_variable
# [target_CUDA_architectures]) -- Selects GPU arch flags for nvcc based on
# target_CUDA_architectures target_CUDA_architectures : Auto | Common | All |
# LIST(ARCH_AND_PTX ...) - "Auto" detects local machine GPU compute arch at
# runtime. - "Common" and "All" cover common and entire subsets of architectures
# ARCH_AND_PTX : NAME | NUM.NUM | NUM.NUM(NUM.NUM) | NUM.NUM+PTX NAME: Fermi
# Kepler Maxwell Kepler+Tegra Kepler+Tesla Maxwell+Tegra Pascal Volta Turing
# Ampere NUM: Any number. Only those pairs are currently accepted by NVCC
# though: 2.0 2.1 3.0 3.2 3.5 3.7 5.0 5.2 5.3 6.0 6.2 7.0 7.2 7.5 8.0 8.6
# Returns LIST of flags to be added to CUDA_NVCC_FLAGS in ${out_variable}
# Additionally, sets ${out_variable}_readable to the resulting numeric list
# Example: CUDA_SELECT_NVCC_ARCH_FLAGS(ARCH_FLAGS 3.0 3.5+PTX 5.2(5.0) Maxwell)
...
set(CUDA_KNOWN_GPU_ARCHITECTURES "Fermi" "Kepler" "Maxwell" "Kepler+Tegra"
                                 "Kepler+Tesla" "Maxwell+Tegra")
...
function(CUDA_DETECT_INSTALLED_GPUS OUT_VARIABLE)
  if(NOT CUDA_GPU_DETECT_OUTPUT)
    ...
    if(CMAKE_CUDA_COMPILER_LOADED) # CUDA as a language
      ...
      try_run(
        run_result compile_result SOURCES ${file}
  ...
  if(NOT CUDA_GPU_DETECT_OUTPUT)
    ...
    foreach(ITEM IN ITEMS ${CUDA_GPU_DETECT_OUTPUT})
      if(CUDA_LIMIT_GPU_ARCHITECTURE AND ITEM VERSION_GREATER_EQUAL
