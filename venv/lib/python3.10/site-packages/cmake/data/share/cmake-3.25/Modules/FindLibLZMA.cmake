...
if(NOT LIBLZMA_LIBRARY)
  find_library(
    ...
    NAMES lzma liblzma NAMES_PER_DIR
    PATH_SUFFIXES lib)
  find_library(
    LIBLZMA_LIBRARY_DEBUG
    NAMES lzmad liblzmad NAMES_PER_DIR
    PATH_SUFFIXES lib)
...
if(LIBLZMA_INCLUDE_DIR AND EXISTS "${LIBLZMA_INCLUDE_DIR}/lzma/version.h")
  file(STRINGS "${LIBLZMA_INCLUDE_DIR}/lzma/version.h" LIBLZMA_HEADER_CONTENTS
       REGEX "#define LZMA_VERSION_[A-Z]+ [0-9]+")
...
# We're using new code known now as XZ, even library still been called LZMA it
# can be found in http://tukaani.org/xz/ Avoid using old codebase
if(LIBLZMA_LIBRARY)
  ...
  check_library_exists(${LIBLZMA_LIBRARY_check} lzma_auto_decoder ""
                       LIBLZMA_HAS_AUTO_DECODER)
  check_library_exists(${LIBLZMA_LIBRARY_check} lzma_easy_encoder ""
                       LIBLZMA_HAS_EASY_ENCODER)
  check_library_exists(${LIBLZMA_LIBRARY_check} lzma_lzma_preset ""
                       LIBLZMA_HAS_LZMA_PRESET)
...
find_package_handle_standard_args(
  LibLZMA
  REQUIRED_VARS LIBLZMA_LIBRARY LIBLZMA_INCLUDE_DIR LIBLZMA_HAS_AUTO_DECODER
...
if(LIBLZMA_FOUND)
  ...
  if(NOT TARGET LibLZMA::LibLZMA)
    ...
    set_target_properties(
      LibLZMA::LibLZMA
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${LIBLZMA_INCLUDE_DIR}
                 IMPORTED_LINK_INTERFACE_LANGUAGES C)

    if(LIBLZMA_LIBRARY_RELEASE)
      set_property(
        TARGET LibLZMA::LibLZMA
        APPEND
        PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
      set_target_properties(
        LibLZMA::LibLZMA PROPERTIES IMPORTED_LOCATION_RELEASE
                                    "${LIBLZMA_LIBRARY_RELEASE}")
    endif()
    ...
    if(LIBLZMA_LIBRARY_DEBUG)
      ...
      set_target_properties(
        LibLZMA::LibLZMA PROPERTIES IMPORTED_LOCATION_DEBUG
                                    "${LIBLZMA_LIBRARY_DEBUG}")
    endif()
