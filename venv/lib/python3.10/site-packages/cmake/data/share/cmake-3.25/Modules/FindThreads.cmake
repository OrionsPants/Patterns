...
macro(_threads_check_flag_pthread)
  if(NOT Threads_FOUND)
    ...
    elseif(NOT DEFINED THREADS_HAVE_PTHREAD_ARG)
      ...
      try_compile(
        THREADS_HAVE_PTHREAD_ARG SOURCE_FROM_FILE
        "${_threads_src}" "${CMAKE_CURRENT_LIST_DIR}/CheckForPthreads.c"
...
# already exist in C library, we could just use them instead of linking to the
# additional pthread library.
_threads_check_libc()

# Check for -pthread first if enabled. This is the recommended way, but not
# backwards compatible as one must also pass -pthread as compiler flag then.
