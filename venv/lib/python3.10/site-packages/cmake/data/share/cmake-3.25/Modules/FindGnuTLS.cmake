...
if(NOT WIN32)
  # try using pkg-config to get the directories and then use these values in the
  # find_path() and find_library() calls also fills in GNUTLS_DEFINITIONS,
  # although that isn't normally useful
...
find_path(GNUTLS_INCLUDE_DIR gnutls/gnutls.h HINTS ${PC_GNUTLS_INCLUDEDIR}
...
if(GNUTLS_FOUND)
  ...
  if(NOT TARGET GnuTLS::GnuTLS)
    ...
    set_target_properties(
      GnuTLS::GnuTLS
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${GNUTLS_INCLUDE_DIRS}"
