...
#define CCONV
  ...
  typedef struct
  {
    ...
    void(CCONV* ExpandSourceListArguments)(
        void* mf,
        int argc,
        const char** argv,
        int* resArgc,
    ...
    =========================================================================*/
    void(CCONV* AddCustomCommandToOutput)(
        void* mf,
        const char* output,
        const char* command,
        int numArgs,
        ...
        int numDepends,
        const char** depends);
    void(CCONV* AddCustomCommandToTarget)(
        void* mf,
        const char* target,
        const char* command,
        int numArgs,
    ...
    void(CCONV*
             DefineSourceFileProperty)(void* mf, const char* name, const char* briefDocs, const char* longDocs, int chained);
