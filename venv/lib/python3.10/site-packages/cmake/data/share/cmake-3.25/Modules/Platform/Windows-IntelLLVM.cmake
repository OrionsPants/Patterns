...
# Platform/Windows-MSVC adds some linking options icx/ifx do not understand, but
# that need to be passed to the linker.  Wrap all the linking options from
...
foreach(t EXE SHARED MODULE STATIC)
  ...
  foreach(flag ${CMAKE_${t}_LINKER_FLAGS_INIT})
    ...
    list(APPEND _wrapped_linker_flags
         "${_IntelLLVM_LINKER_WRAPPER_FLAG}${flag}")
  endforeach()
  set(CMAKE_${t}_LINKER_FLAGS_INIT "")
...
macro(__windows_compiler_intel lang)
  ...
  set(CMAKE_${lang}_LINKER_WRAPPER_FLAG_SEP
      "${_IntelLLVM_LINKER_WRAPPER_FLAG_SEP}")
  ...
  if(NOT "${lang}" STREQUAL "Fortran" OR CMAKE_${lang}_COMPILER_VERSION
                                         VERSION_GREATER_EQUAL 2022.1)
    # The Fortran driver does not support -fuse-ld=llvm-lib before compiler
    # version 2022.1
