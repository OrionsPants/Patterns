...
# Set explicitly, because __compiler_clang() doesn't set this if we're
# simulating MSVC.
...
# C++03 isn't supported for CXX, but is for CUDA, so we need to set these
# manually. Do this before __compiler_clang_cxx_standards() since that adds the
# feature.
...
# RulePlaceholderExpander expands crosscompile variables like sysroot and target
# only for CMAKE_<LANG>_COMPILER. Override the default.
set(CMAKE_CUDA_LINK_EXECUTABLE
    "<CMAKE_CUDA_COMPILER> <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>${__IMPLICIT_LINKS}"
)
set(CMAKE_CUDA_CREATE_SHARED_LIBRARY
    "<CMAKE_CUDA_COMPILER> <CMAKE_SHARED_LIBRARY_CUDA_FLAGS> <LINK_FLAGS> <CMAKE_SHARED_LIBRARY_CREATE_CUDA_FLAGS> <SONAME_FLAG><TARGET_SONAME> -o <TARGET> <OBJECTS> <LINK_LIBRARIES>${__IMPLICIT_LINKS}"
)
...
if(UNIX)
  list(APPEND CMAKE_CUDA_RUNTIME_LIBRARY_LINK_OPTIONS_STATIC "rt" "pthread"
       "dl")
endif()
