...
# This file sets the basic flags for the C language in CMake. It also loads the
# available platform file for the system-compiler if it exists. It also loads a
# system - compiler - processor (or target hardware) specific file, which is
# mainly useful for crosscompiling and embedded systems.
...
if(CMAKE_SYSTEM_PROCESSOR)
  if(CMAKE_C_COMPILER_ID)
    include(
      Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_C_COMPILER_ID}-C-${CMAKE_SYSTEM_PROCESSOR}
      OPTIONAL
...
cmake_initialize_per_config_variable(CMAKE_C_FLAGS
...
# CMAKE_C_CREATE_SHARED_LIBRARY CMAKE_C_CREATE_SHARED_MODULE
# CMAKE_C_COMPILE_OBJECT CMAKE_C_LINK_EXECUTABLE
...
# C compiler information <CMAKE_C_COMPILER>
...
# CMAKE_C_CREATE_STATIC_LIBRARY is set it will override these.
...
if(NOT CMAKE_EXECUTABLE_RPATH_LINK_C_FLAG)
  set(CMAKE_EXECUTABLE_RPATH_LINK_C_FLAG
