...
function(CMAKE_CHECK_LINKER_FLAG _lang _flag _var)
  # link step supports less languages than the compiler so do a first check
  # about the requested language
  ...
  cmake_check_flag_common_init("check_linker_flag" ${_lang} _lang_src
                               _lang_fail_regex)
  ...
  foreach(flag IN LISTS _flag)
    ...
    list(APPEND _common_patterns FAIL_REGEX
         "warning: .*${_flag_regex}.* ignored")
  endforeach()
