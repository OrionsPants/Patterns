...
if(GLEW_FOUND)
  ...
  get_target_property(GLEW_INCLUDE_DIRS GLEW::GLEW
  ...
  if("${_GLEW_DEFS}" MATCHES "GLEW_STATIC")
    ...
    get_target_property(GLEW_LIBRARY_RELEASE GLEW::GLEW
  ...
  get_target_property(
    _GLEW_LINK_INTERFACE GLEW::GLEW IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE
...
function(__glew_set_find_library_suffix shared_or_static)
  ...
  if(GLEW_VERBOSE)
    message(
      STATUS
        "FindGLEW: CMAKE_FIND_LIBRARY_SUFFIXES for ${shared_or_static}: ${CMAKE_FIND_LIBRARY_SUFFIXES}"
    )
  endif()
endfunction()
...
if(GLEW_VERBOSE)
  if(DEFINED GLEW_USE_STATIC_LIBS)
    ...
    message(
      STATUS "FindGLEW: GLEW_USE_STATIC_LIBS is undefined. Treated as FALSE.")
  endif()
endif()
...
find_library(
  ...
  NAMES GLEW glew glew32 NAMES_PER_DIR
  PATH_SUFFIXES lib lib64 libx32 lib/Release/${_arch}
  PATHS ENV GLEW_ROOT)

find_library(
  GLEW_SHARED_LIBRARY_DEBUG
  NAMES GLEWd glewd glew32d NAMES_PER_DIR
...
find_library(
  ...
  NAMES GLEW glew glew32s NAMES_PER_DIR
  PATH_SUFFIXES lib lib64 libx32 lib/Release/${_arch}
  PATHS ENV GLEW_ROOT)

find_library(
  GLEW_STATIC_LIBRARY_DEBUG
  NAMES GLEWds glewds glew32ds NAMES_PER_DIR
  PATH_SUFFIXES lib lib64
  PATHS ENV GLEW_ROOT)
...
if(GLEW_VERBOSE)
  message(
    STATUS
      "FindGLEW: GLEW_SHARED_LIBRARY_RELEASE: ${GLEW_SHARED_LIBRARY_RELEASE}")
  message(
    STATUS
      "FindGLEW: GLEW_STATIC_LIBRARY_RELEASE: ${GLEW_STATIC_LIBRARY_RELEASE}")
  message(
    STATUS "FindGLEW: GLEW_SHARED_LIBRARY_DEBUG: ${GLEW_SHARED_LIBRARY_DEBUG}")
  message(
    STATUS "FindGLEW: GLEW_STATIC_LIBRARY_DEBUG: ${GLEW_STATIC_LIBRARY_DEBUG}")
...
if(EXISTS "${GLEW_INCLUDE_DIR}/GL/glew.h")
  file(STRINGS "${GLEW_INCLUDE_DIR}/GL/glew.h" _contents
       REGEX "^VERSION_.+ [0-9]+")
  if(_contents)
    string(REGEX REPLACE ".*VERSION_MAJOR[ \t]+([0-9]+).*" "\\1"
                         GLEW_VERSION_MAJOR "${_contents}")
    string(REGEX REPLACE ".*VERSION_MINOR[ \t]+([0-9]+).*" "\\1"
                         GLEW_VERSION_MINOR "${_contents}")
    string(REGEX REPLACE ".*VERSION_MICRO[ \t]+([0-9]+).*" "\\1"
                         GLEW_VERSION_MICRO "${_contents}")
    set(GLEW_VERSION
...
if(NOT TARGET GLEW::glew AND NOT GLEW_USE_STATIC_LIBS)
  ...
  if(GLEW_SHARED_LIBRARY_RELEASE)
    ...
    set_target_properties(
      GLEW::glew PROPERTIES IMPORTED_LOCATION_RELEASE
                            "${GLEW_SHARED_LIBRARY_RELEASE}")
  endif()
  ...
  if(GLEW_SHARED_LIBRARY_DEBUG)
    ...
    set_target_properties(GLEW::glew PROPERTIES IMPORTED_LOCATION_DEBUG
                                                "${GLEW_SHARED_LIBRARY_DEBUG}")
  endif()
...
elseif(NOT TARGET GLEW::glew_s AND GLEW_USE_STATIC_LIBS)
  ...
  set_target_properties(GLEW::glew_s PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                                "${GLEW_INCLUDE_DIRS}")

  if(APPLE)
    set_target_properties(GLEW::glew_s PROPERTIES INTERFACE_LINK_LIBRARIES
                                                  OpenGL::GL)
  endif()
  ...
  if(GLEW_STATIC_LIBRARY_RELEASE)
    ...
    set_target_properties(
      GLEW::glew_s PROPERTIES IMPORTED_LOCATION_RELEASE
                              "${GLEW_STATIC_LIBRARY_RELEASE}")
  endif()
  ...
  if(GLEW_STATIC_LIBRARY_DEBUG)
    ...
    set_target_properties(
      GLEW::glew_s PROPERTIES IMPORTED_LOCATION_DEBUG
                              "${GLEW_STATIC_LIBRARY_DEBUG}")
  endif()
endif()
...
if(NOT TARGET GLEW::GLEW)
  ...
  if(TARGET GLEW::glew)
    ...
    if(GLEW_SHARED_LIBRARY_DEBUG)
      ...
      set_target_properties(
        GLEW::GLEW PROPERTIES IMPORTED_LOCATION_DEBUG
                              "${GLEW_SHARED_LIBRARY_DEBUG}")
    endif()
  ...
  elseif(GLEW_VERBOSE)
    message(
      WARNING
        "FindGLEW: no `GLEW::glew` or `GLEW::glew_s` target was created. Something went wrong in FindGLEW target creation."
    )
  endif()
endif()
