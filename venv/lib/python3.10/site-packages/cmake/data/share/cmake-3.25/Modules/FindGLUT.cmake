...
if(WIN32)
  ...
  find_library(
    ...
    HINTS ${PC_GLUT_LIBRARY_DIRS})
  # N.B. As the pkg-config cannot distinguish between release and debug
  # libraries, assume that their hint was the both Debug and Release library.
  find_library(
    GLUT_glut_LIBRARY_DEBUG
    NAMES freeglutd
    PATHS ${OPENGL_LIBRARY_DIR} ${GLUT_ROOT_PATH}/Debug
    HINTS ${PC_GLUT_LIBRARY_DIRS})
...
elseif(APPLE)
  ...
  if(GLUT_cocoa_LIBRARY AND NOT TARGET GLUT::Cocoa)
    ...
    if(GLUT_cocoa_LIBRARY MATCHES "/([^/]+)\\.framework$")
      ...
      set_target_properties(GLUT::Cocoa PROPERTIES IMPORTED_LOCATION
                                                   "${_glut_cocoa}")
    else()
      set_target_properties(GLUT::Cocoa PROPERTIES IMPORTED_LOCATION
                                                   "${GLUT_cocoa_LIBRARY}")
  ...
  if(BEOS)
    ...
    if(GLUT_Xi_LIBRARY AND NOT TARGET GLUT::Xi)
      ...
      set_target_properties(GLUT::Xi PROPERTIES IMPORTED_LOCATION
                                                "${GLUT_Xi_LIBRARY}")
    endif()

    if(GLUT_Xmu_LIBRARY AND NOT TARGET GLUT::Xmu)
      add_library(GLUT::Xmu UNKNOWN IMPORTED)
      set_target_properties(GLUT::Xmu PROPERTIES IMPORTED_LOCATION
                                                 "${GLUT_Xmu_LIBRARY}")
    endif()
  ...
  find_path(
    ...
    PATHS /usr/include/GL /usr/openwin/share/include /usr/openwin/include
          /opt/graphics/OpenGL/include /opt/graphics/OpenGL/contrib/libglut
          ${_GLUT_INC_DIR}
    HINTS ${PC_GLUT_INCLUDE_DIRS})
  mark_as_advanced(GLUT_INCLUDE_DIR)
  ...
  find_library(
    GLUT_glut_LIBRARY glut
    PATHS /usr/openwin/lib ${_GLUT_glut_LIB_DIR}
    HINTS ${PC_GLUT_LIBRARY_DIRS})
...
if(GLUT_FOUND)
  # Is -lXi and -lXmu required on all platforms that have it? If not, we need
  ...
  if(NOT TARGET GLUT::GLUT)
    ...
    set_target_properties(GLUT::GLUT PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                                "${GLUT_INCLUDE_DIRS}")
    if(GLUT_glut_LIBRARY MATCHES "/([^/]+)\\.framework$")
      ...
      set_target_properties(GLUT::GLUT PROPERTIES IMPORTED_LOCATION
                                                  "${_glut_glut}")
    else()
      if(GLUT_glut_LIBRARY_RELEASE)
        ...
        set_target_properties(
          GLUT::GLUT PROPERTIES IMPORTED_LOCATION_RELEASE
                                "${GLUT_glut_LIBRARY_RELEASE}")
      endif()
      ...
      if(GLUT_glut_LIBRARY_DEBUG)
        ...
        set_target_properties(
          GLUT::GLUT PROPERTIES IMPORTED_LOCATION_DEBUG
                                "${GLUT_glut_LIBRARY_DEBUG}")
      endif()
      ...
      if(NOT GLUT_glut_LIBRARY_RELEASE AND NOT GLUT_glut_LIBRARY_DEBUG)
        set_property(
          TARGET GLUT::GLUT
          APPEND
          PROPERTY IMPORTED_LOCATION "${GLUT_glut_LIBRARY}")
      endif()
    endif()
