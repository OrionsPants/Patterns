...
macro(__cmake_include_compiler_wrapper lang)
  ...
  if(CMAKE_${lang}_COMPILER_ID)
    include(
      Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_${lang}_COMPILER_WRAPPER}-${CMAKE_${lang}_COMPILER_ID}-${lang}
      OPTIONAL
      RESULT_VARIABLE _INCLUDED_WRAPPER_FILE)
  endif()
  if(NOT _INCLUDED_WRAPPER_FILE)
    include(
      Platform/${CMAKE_EFFECTIVE_SYSTEM_NAME}-${CMAKE_${lang}_COMPILER_WRAPPER}-${lang}
      OPTIONAL
      RESULT_VARIABLE _INCLUDED_WRAPPER_FILE)
  endif()
  ...
  if(NOT _INCLUDED_WRAPPER_FILE)
    if(CMAKE_${lang}_COMPILER_ID)
      include(
        Compiler/${CMAKE_${lang}_COMPILER_WRAPPER}-${CMAKE_${lang}_COMPILER_ID}-${lang}
        OPTIONAL
        RESULT_VARIABLE _INCLUDED_WRAPPER_FILE)
    endif()
    if(NOT _INCLUDED_WRAPPER_FILE)
