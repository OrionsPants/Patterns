...
# Detect the CERTI installation, http://www.cert.fr/CERTI Detect the MAK
# Technologies RTI installation, http://www.mak.com/products/rti.php note: the
# following list is ordered to find the most recent version first
...
if(RTI_FEDTIME_LIBRARY)
  ...
  rti_message_quietly(RTI_FIND_QUIETLY STATUS
                      "RTI FedTime found: ${RTI_FEDTIME_LIBRARY}")
endif()
...
if(RTI_INCLUDE_DIR)
  rti_message_quietly(RTI_FIND_QUIETLY STATUS
                      "RTI headers found: ${RTI_INCLUDE_DIR}")
else()
...
find_package_handle_standard_args(RTI DEFAULT_MSG RTI_LIBRARY RTI_INCLUDE_DIR)
