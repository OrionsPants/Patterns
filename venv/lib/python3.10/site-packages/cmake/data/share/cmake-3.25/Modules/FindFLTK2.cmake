...
if(APPLE)
  set(FLTK2_PLATFORM_DEPENDENT_LIBS
...
set(FLTK2_DIR_STRING
    "directory containing FLTK2Config.cmake.  This is either the root of the build tree, or PREFIX/lib/fltk for an installation."
)
...
if(NOT FLTK2_DIR)
  ...
  find_path(
    ...
    ${FLTK2_DIR_SEARCH}
    PATH_SUFFIXES fltk2 fltk2/include lib/fltk2 lib/fltk2/include
  ...
  if(FLTK2_BUILT_WITH_CMAKE)
    ...
    if(FLUID_COMMAND)
      set(FLTK2_FLUID_EXECUTABLE
          ${FLUID_COMMAND}
          CACHE FILEPATH "Fluid executable")
    else()
      find_program(
        FLTK2_FLUID_EXECUTABLE fluid2
        PATHS ${FLTK2_EXECUTABLE_DIRS} ${FLTK2_EXECUTABLE_DIRS}/RelWithDebInfo
              ${FLTK2_EXECUTABLE_DIRS}/Debug ${FLTK2_EXECUTABLE_DIRS}/Release
              NO_SYSTEM_PATH)
    endif()
    ...
    load_cache(
      ${FLTK2_DIR}
      READ_WITH_PREFIX FL FLTK2_USE_SYSTEM_JPEG FL FLTK2_USE_SYSTEM_PNG FL
    ...
    set(FLTK2_IMAGES_LIBS
        "${FLTK2_IMAGES_LIBS}"
        CACHE INTERNAL "Extra libraries for fltk2_images library.")

  else()

    # if FLTK2 was not built using CMake Find fluid executable.
    ...
    if(FLTK2_FLUID_EXECUTABLE)
      ...
      set(FLTK2_INCLUDE_SEARCH_PATH
          ${FLTK2_INCLUDE_SEARCH_PATH} ${FLTK2_BIN_DIR}/../include
          ${FLTK2_BIN_DIR}/..)
    ...
    find_path(FLTK2_INCLUDE_DIR fltk/run.h ${FLTK2_INCLUDE_SEARCH_PATH}
              PATH_SUFFIXES fltk2 fltk2/include)
    ...
    if(UNIX)
      ...
      if(FLTK2_CONFIG_SCRIPT)
        ...
        if("${FLTK2_IMAGES_LDFLAGS}" MATCHES "${FLTK2_LIBS_EXTRACT_REGEX}")
          ...
          # The EXEC_PROGRAM will not be inherited into subdirectories from the
          # file that originally included this module.  Save the answer.
          set(FLTK2_IMAGES_LIBS
              "${FLTK2_IMAGES_LIBS}"
              CACHE INTERNAL "Extra libraries for fltk_images library.")
        endif()
      endif()
    endif()
...
set(FLTK2_FOUND 1)
foreach(var FLTK2_FLUID_EXECUTABLE FLTK2_INCLUDE_DIR FLTK2_BASE_LIBRARY
            FLTK2_GL_LIBRARY FLTK2_IMAGES_LIBRARY)
  if(NOT ${var})
...
if(FLTK2_FOUND)
  set(FLTK2_LIBRARIES ${FLTK2_IMAGES_LIBRARY} ${FLTK2_IMAGES_LIBS}
