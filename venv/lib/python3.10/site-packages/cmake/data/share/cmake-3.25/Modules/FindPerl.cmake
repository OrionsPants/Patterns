...
if(PERL_EXECUTABLE)
  # PERL_VERSION
  execute_process(
    COMMAND ${PERL_EXECUTABLE} -V:version
  ...
  if(NOT PERL_VERSION_RESULT_VARIABLE AND NOT PERL_VERSION_OUTPUT_VARIABLE
    ...
    if(NOT PERL_VERSION_RESULT_VARIABLE
       AND PERL_VERSION_OUTPUT_VARIABLE MATCHES
           "This is perl.*[ \\(]v([0-9\\._]+)[ \\)]")
      set(PERL_VERSION_STRING "${CMAKE_MATCH_1}")
    elseif(NOT PERL_VERSION_RESULT_VARIABLE
           AND PERL_VERSION_OUTPUT_VARIABLE MATCHES
               "This is perl, version ([0-9\\._]+) +")
      set(PERL_VERSION_STRING "${CMAKE_MATCH_1}")
    endif()
  endif()
endif()
