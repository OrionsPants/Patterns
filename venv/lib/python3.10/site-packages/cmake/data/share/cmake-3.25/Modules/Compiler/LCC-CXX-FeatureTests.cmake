...
set(GNU50_CXX14
    "(__GNUC__ * 100 + __GNUC_MINOR__) >= 500 && __cplusplus >= 201402L")
...
# correct value of it below. https://patchwork.ozlabs.org/patch/382470/
set(GNU49_CXX14
    "(__GNUC__ * 100 + __GNUC_MINOR__) >= 409 && __cplusplus > 201103L")
...
# GNU 4.3 supports binary literals as an extension, but may warn about use of
# extensions prior to GNU 4.9
...
# earlier draft of the standard paper), but that version of the compiler does
# not set __cplusplus to a value greater than 201103L until GNU 4.9:
...
set(GNU481_CXX11
    "((__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__) >= 40801) && __cplusplus >= 201103L"
)
...
# The alignof feature works with GNU 4.7 and -std=c++11, but it is documented as
# available with GNU 4.8, so treat that as true.
...
set(GNU47_CXX11
    "(__GNUC__ * 100 + __GNUC_MINOR__) >= 407 && __cplusplus >= 201103L")
...
# NOTE: C++11 was ratified in September 2011. GNU 4.7 is the first minor release
# following that (March 2012), and the first minor release to support
# -std=c++11. Prior to that, support for C++11 features is technically
# experiemental and possibly incomplete (see for example the note below about
# cxx_variadic_template_template_parameters) GNU does not define __cplusplus
# correctly before version 4.7.
# https://gcc.gnu.org/bugzilla/show_bug.cgi?id=1773 __GXX_EXPERIMENTAL_CXX0X__
# is defined in prior versions, but may not be defined in the future.
set(GNU_CXX0X_DEFINED
    "(__cplusplus >= 201103L || (defined(__GXX_EXPERIMENTAL_CXX0X__) && __GXX_EXPERIMENTAL_CXX0X__))"
)
set(GNU46_CXX11
    "(__GNUC__ * 100 + __GNUC_MINOR__) >= 406 && ${GNU_CXX0X_DEFINED}")
...
set(GNU45_CXX11
    "(__GNUC__ * 100 + __GNUC_MINOR__) >= 405 && ${GNU_CXX0X_DEFINED}")
...
set(GNU44_CXX11
    "(__GNUC__ * 100 + __GNUC_MINOR__) >= 404 && ${GNU_CXX0X_DEFINED}")
...
# TODO: If features are ever recorded for GNU 4.3, there should possibly be a
# new feature added like cxx_variadic_template_template_parameters, which is
# implemented by GNU 4.4, but not 4.3. cxx_variadic_templates is actually
# implemented by GNU 4.3, but variadic template template parameters 'completes'
# it, so that is the version we record as having the variadic templates
# capability in CMake. See
# http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2008/n2555.pdf TODO: Should
# be supported by GNU 4.3
...
set(_cmake_feature_test_cxx_extern_templates
