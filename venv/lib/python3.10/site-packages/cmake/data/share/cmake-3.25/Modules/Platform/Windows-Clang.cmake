...
macro(__windows_compiler_clang_gnu lang)
  ...
  if(NOT "${lang}" STREQUAL "ASM")
    set(CMAKE_${lang}_COMPILE_OPTIONS_MSVC_RUNTIME_LIBRARY_MultiThreaded
        -Xclang -flto-visibility-public-std -D_MT -Xclang
  ...
  set(CMAKE_${lang}_COMPILE_OPTIONS_USE_PCH
      -Xclang
      -include-pch
      -Xclang
      <PCH_FILE>
...
macro(__enable_llvm_rc_preprocessing clang_option_prefix extra_pp_flags)
  ...
  if(CMAKE_RC_COMPILER_INIT MATCHES "llvm-rc" OR CMAKE_RC_COMPILER MATCHES
                                                 "llvm-rc")
    ...
    if(DEFINED CMAKE_RC_PREPROCESSOR)
      set(CMAKE_DEPFILE_FLAGS_RC
          "${clang_option_prefix}-MD ${clang_option_prefix}-MF ${clang_option_prefix}<DEP_FILE>"
      )
      # The <FLAGS> are passed to the preprocess and the resource compiler to
      # pick up the eventual -D / -C options passed through the CMAKE_RC_FLAGS.
      set(CMAKE_RC_COMPILE_OBJECT
          "<CMAKE_COMMAND> -E cmake_llvm_rc <SOURCE> <OBJECT>.pp <${CMAKE_RC_PREPROCESSOR}> <DEFINES> -DRC_INVOKED <INCLUDES> <FLAGS> ${extra_pp_flags} -E -- <SOURCE> ++ <CMAKE_RC_COMPILER> <DEFINES> -I <SOURCE_DIR> <INCLUDES> <FLAGS> /fo <OBJECT> <OBJECT>.pp"
      )
...
if("x${CMAKE_C_SIMULATE_ID}" STREQUAL "xMSVC"
  ...
  __verify_same_language_values(
    COMPILER_ID "The current configuration mixes Clang and MSVC or "
  ...
  if(NOT CMAKE_RC_COMPILER_INIT)
    # Check if rc is already in the path This may happen in cases where the user
    # is already in a visual studio environment when CMake is invoked
  ...
  if("x${CMAKE_CXX_COMPILER_FRONTEND_VARIANT}" STREQUAL "xMSVC"
    ...
    # Set the clang option forwarding prefix for clang-cl usage in the llvm-rc
    # processing stage
    ...
    macro(__windows_compiler_clang_base lang)
      ...
      unset(
        CMAKE_${lang}_COMPILE_OPTIONS_MSVC_DEBUG_INFORMATION_FORMAT_EditAndContinue
      ) # -ZI not supported by Clang
