...
if(NOT ZLIB_LIBRARY)
  ...
  foreach(search ${_ZLIB_SEARCHES})
    find_library(
      ...
      NAMES ${ZLIB_NAMES} NAMES_PER_DIR ${${search}}
      PATH_SUFFIXES lib)
    find_library(
      ZLIB_LIBRARY_DEBUG
      NAMES ${ZLIB_NAMES_DEBUG} NAMES_PER_DIR ${${search}}
      PATH_SUFFIXES lib)
  endforeach()
