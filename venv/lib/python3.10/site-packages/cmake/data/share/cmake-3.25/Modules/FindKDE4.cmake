...
if(QT_QT_LIBRARY)
  if(KDE4_FIND_REQUIRED)
    message(
      FATAL_ERROR "KDE4/Qt4 and Qt3 cannot be used together in one project.")
  else()
...
# doesn't make a lot of sense. We'll have to do something about this. Searching
# always in the target environment ? Then we get at least the correct one, still
# it can't be used to run it. Alex

# For KDE4 kde-config has been renamed to kde4-config
find_program(
  KDE4_KDECONFIG_EXECUTABLE
  NAMES kde4-config
  # the suffix must be used since KDEDIRS can be a list of directories which
  # don't have bin/ appended
  PATH_SUFFIXES bin
  HINTS ${CMAKE_INSTALL_PREFIX} ${_KDEDIRS} /opt/kde4
...
if(NOT KDE4_DATA_DIR)
  if(CMAKE_CROSSCOMPILING)
    # when cross compiling, don't run kde4-config but use its location as
    # install dir
...
if(KDE4_DATA_DIR)
  ...
  if(KDE4_FIND_REQUIRED)
    message(
      FATAL_ERROR
        "ERROR: cmake/modules/FindKDE4Internal.cmake not found in ${_data_DIR}")
  endif()
endif()
