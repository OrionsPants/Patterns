...
# Do NOT include this module directly into any of your code. It is meant as a
# library for Check*CompilerFlag.cmake and Check*LinkerFlag.cma modules. It's
# content may change in any way between releases.
...
macro(CMAKE_CHECK_FLAG_COMMON_INIT _FUNC _LANG _SRC _PATTERNS)
  ...
  elseif("${_LANG}" STREQUAL "CUDA")
    ...
    set(${_PATTERNS}
        FAIL_REGEX
        "command[ -]line option .* is valid for .* but not for C\\+\\+" # Host GNU
        FAIL_REGEX
  ...
  elseif("${_LANG}" STREQUAL "Fortran")
    ...
    set(${_PATTERNS}
        FAIL_REGEX
        "command[ -]line option .* is valid for .* but not for Fortran")
  elseif("${_LANG}" STREQUAL "HIP")
    set(${_SRC} "__host__ int main() { return 0; }")
    set(${_PATTERNS} FAIL_REGEX "argument unused during compilation: .*"
    )# Clang
  elseif("${_LANG}" STREQUAL "OBJC")
    ...
    set(${_PATTERNS}
        FAIL_REGEX
        "command[ -]line option .* is valid for .* but not for Objective-C" # GNU
        FAIL_REGEX
        "argument unused during compilation: .*") # Clang
