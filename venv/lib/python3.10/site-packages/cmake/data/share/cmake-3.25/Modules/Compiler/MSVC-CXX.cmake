...
if((CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 19.0.24215.1
    AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.10)
   OR CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 19.10.25017)

  # VS 2015 Update 3 and above support language standard level flags, with the
  # default and minimum level being C++14.
...
elseif(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 16.0)
  ...
  # There are no compiler modes so we only need to test features once. Override
  # the default macro for this special case.  Pretend that all language
  # standards are available so that at least compilation can be attempted.
...
if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "19.34")
  ...
  string(
    CONCAT
      ...
      " -showIncludes" " -scanDependencies <DYNDEP_FILE>" " -Fo<OBJECT>")
